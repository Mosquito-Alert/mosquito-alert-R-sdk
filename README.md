...
R CMD build .
R CMD check MosquitoAlert_0.1.22.tar.gz --no-manual
R CMD INSTALL --preclean MosquitoAlert_0.1.22.tar.gz
```
...
```R
install.packages("MosquitoAlert_0.1.22.tar.gz", repos = NULL, type = "source")
```
