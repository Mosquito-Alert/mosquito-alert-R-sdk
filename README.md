...
R CMD build .
R CMD check MosquitoAlert_0.4.8.tar.gz --no-manual
R CMD INSTALL --preclean MosquitoAlert_0.4.8.tar.gz
```
...
```R
install.packages("MosquitoAlert_0.4.8.tar.gz", repos = NULL, type = "source")
```
...
*MessagesApi* | [**recipients_stats_retrieve**](docs/MessagesApi.md#recipients_stats_retrieve) | **GET** /messages/{id}/recipients/stats/ | 
*MessagesApi* | [**retrieve**](docs/MessagesApi.md#retrieve) | **GET** /messages/{id}/ | 
*MessagesApi* | [**targeting_retrieve**](docs/MessagesApi.md#targeting_retrieve) | **GET** /messages/{id}/targeting/ | 
...
*UsersApi* | [**audience_filter**](docs/UsersApi.md#audience_filter) | **POST** /users/audience/ | 
...
## Documentation for Models
 ...
 - [CreateAudienceMessageContentRequest](docs/CreateAudienceMessageContentRequest.md)
 - [CreateAudienceMessageRequest](docs/CreateAudienceMessageRequest.md)
 ...
 - [LocalizedAudienceMessageBodyRequest](docs/LocalizedAudienceMessageBodyRequest.md)
 - [LocalizedAudienceMessageTitleRequest](docs/LocalizedAudienceMessageTitleRequest.md)
 - [LocalizedMessageBody](docs/LocalizedMessageBody.md)
 - [LocalizedMessageBodyPreview](docs/LocalizedMessageBodyPreview.md)
 ...
 - [MessageListContent](docs/MessageListContent.md)
 - [MessagePermission](docs/MessagePermission.md)
 - [MessageRecipient](docs/MessageRecipient.md)
 - [MessageRecipientStats](docs/MessageRecipientStats.md)
 - [MessageTargeting](docs/MessageTargeting.md)
 - [MessagesCreateAudienceInAreaErrorComponent](docs/MessagesCreateAudienceInAreaErrorComponent.md)
 - [MessagesCreateAudienceLastLoginAfterErrorComponent](docs/MessagesCreateAudienceLastLoginAfterErrorComponent.md)
 - [MessagesCreateAudienceLastLoginBeforeErrorComponent](docs/MessagesCreateAudienceLastLoginBeforeErrorComponent.md)
 - [MessagesCreateAudienceLocaleErrorComponent](docs/MessagesCreateAudienceLocaleErrorComponent.md)
 - [MessagesCreateAudienceNonFieldErrorsErrorComponent](docs/MessagesCreateAudienceNonFieldErrorsErrorComponent.md)
 - [MessagesCreateAudienceNotificationTopicsErrorComponent](docs/MessagesCreateAudienceNotificationTopicsErrorComponent.md)
 - [MessagesCreateAudienceNotificationTopicsINDEXErrorComponent](docs/MessagesCreateAudienceNotificationTopicsINDEXErrorComponent.md)
 ...
 - [MessagesCreateTargetErrorComponent](docs/MessagesCreateTargetErrorComponent.md)
 ...
 - [MessagesListMineSentTargetErrorComponent](docs/MessagesListMineSentTargetErrorComponent.md)
 ...
 - [MessagesListTargetErrorComponent](docs/MessagesListTargetErrorComponent.md)
 ...
 - [MetaCreateMessageRequest](docs/MetaCreateMessageRequest.md)
 ...
 - [PaginatedMessageListList](docs/PaginatedMessageListList.md)
 - [PaginatedMessageRecipientList](docs/PaginatedMessageRecipientList.md)
 ...
 - [UsersAudienceFilterError](docs/UsersAudienceFilterError.md)
 - [UsersAudienceFilterInAreaErrorComponent](docs/UsersAudienceFilterInAreaErrorComponent.md)
 - [UsersAudienceFilterLastLoginAfterErrorComponent](docs/UsersAudienceFilterLastLoginAfterErrorComponent.md)
 - [UsersAudienceFilterLastLoginBeforeErrorComponent](docs/UsersAudienceFilterLastLoginBeforeErrorComponent.md)
 - [UsersAudienceFilterLocaleErrorComponent](docs/UsersAudienceFilterLocaleErrorComponent.md)
 - [UsersAudienceFilterNonFieldErrorsErrorComponent](docs/UsersAudienceFilterNonFieldErrorsErrorComponent.md)
 - [UsersAudienceFilterNotificationTopicsErrorComponent](docs/UsersAudienceFilterNotificationTopicsErrorComponent.md)
 - [UsersAudienceFilterNotificationTopicsINDEXErrorComponent](docs/UsersAudienceFilterNotificationTopicsINDEXErrorComponent.md)
 - [UsersAudienceFilterValidationError](docs/UsersAudienceFilterValidationError.md)
 ...
 - [UsersPartialUpdateNotificationTopicsErrorComponent](docs/UsersPartialUpdateNotificationTopicsErrorComponent.md)
 - [UsersPartialUpdateNotificationTopicsINDEXErrorComponent](docs/UsersPartialUpdateNotificationTopicsINDEXErrorComponent.md)
 ...
 - [UsersUpdateNotificationTopicsErrorComponent](docs/UsersUpdateNotificationTopicsErrorComponent.md)
 - [UsersUpdateNotificationTopicsINDEXErrorComponent](docs/UsersUpdateNotificationTopicsINDEXErrorComponent.md)
