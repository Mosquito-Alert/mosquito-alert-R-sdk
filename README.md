...
R CMD build .
R CMD check MosquitoAlert_0.1.27.tar.gz --no-manual
R CMD INSTALL --preclean MosquitoAlert_0.1.27.tar.gz
```
...
```R
install.packages("MosquitoAlert_0.1.27.tar.gz", repos = NULL, type = "source")
```
