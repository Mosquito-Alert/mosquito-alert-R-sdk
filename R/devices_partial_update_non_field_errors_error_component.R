...
DevicesPartialUpdateNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return DevicesPartialUpdateNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of DevicesPartialUpdateNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DevicesPartialUpdateNonFieldErrorsErrorComponent to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(DevicesPartialUpdateNonFieldErrorsErrorComponentObject)
    },
