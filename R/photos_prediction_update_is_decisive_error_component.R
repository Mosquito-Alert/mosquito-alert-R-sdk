#' Create a new PhotosPredictionUpdateIsDecisiveErrorComponent
#'
#' @description
#' PhotosPredictionUpdateIsDecisiveErrorComponent Class
#'
#' @docType class
#' @title PhotosPredictionUpdateIsDecisiveErrorComponent
#' @description PhotosPredictionUpdateIsDecisiveErrorComponent Class
...
#' @export
PhotosPredictionUpdateIsDecisiveErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PhotosPredictionUpdateIsDecisiveErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return PhotosPredictionUpdateIsDecisiveErrorComponent as a base R list.
    #' @examples
    #' # convert array of PhotosPredictionUpdateIsDecisiveErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PhotosPredictionUpdateIsDecisiveErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PhotosPredictionUpdateIsDecisiveErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        PhotosPredictionUpdateIsDecisiveErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        PhotosPredictionUpdateIsDecisiveErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        PhotosPredictionUpdateIsDecisiveErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(PhotosPredictionUpdateIsDecisiveErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PhotosPredictionUpdateIsDecisiveErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of PhotosPredictionUpdateIsDecisiveErrorComponent
    ...
    #' @return PhotosPredictionUpdateIsDecisiveErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PhotosPredictionUpdateIsDecisiveErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PhotosPredictionUpdateIsDecisiveErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PhotosPredictionUpdateIsDecisiveErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PhotosPredictionUpdateIsDecisiveErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PhotosPredictionUpdateIsDecisiveErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# PhotosPredictionUpdateIsDecisiveErrorComponent$unlock()
#
## Below is an example to define the print function
# PhotosPredictionUpdateIsDecisiveErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PhotosPredictionUpdateIsDecisiveErrorComponent$lock()
