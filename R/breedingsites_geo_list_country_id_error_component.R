#' Create a new BreedingsitesGeoListCountryIdErrorComponent
#'
#' @description
#' BreedingsitesGeoListCountryIdErrorComponent Class
#'
#' @docType class
#' @title BreedingsitesGeoListCountryIdErrorComponent
#' @description BreedingsitesGeoListCountryIdErrorComponent Class
...
#' @export
BreedingsitesGeoListCountryIdErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BreedingsitesGeoListCountryIdErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BreedingsitesGeoListCountryIdErrorComponent as a base R list.
    #' @examples
    #' # convert array of BreedingsitesGeoListCountryIdErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BreedingsitesGeoListCountryIdErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BreedingsitesGeoListCountryIdErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BreedingsitesGeoListCountryIdErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BreedingsitesGeoListCountryIdErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BreedingsitesGeoListCountryIdErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BreedingsitesGeoListCountryIdErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BreedingsitesGeoListCountryIdErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BreedingsitesGeoListCountryIdErrorComponent
    ...
    #' @return BreedingsitesGeoListCountryIdErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BreedingsitesGeoListCountryIdErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesGeoListCountryIdErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesGeoListCountryIdErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesGeoListCountryIdErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BreedingsitesGeoListCountryIdErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BreedingsitesGeoListCountryIdErrorComponent$unlock()
#
## Below is an example to define the print function
# BreedingsitesGeoListCountryIdErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BreedingsitesGeoListCountryIdErrorComponent$lock()
