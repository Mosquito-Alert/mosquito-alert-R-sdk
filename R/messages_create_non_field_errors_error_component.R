#' Create a new MessagesCreateNonFieldErrorsErrorComponent
#'
#' @description
#' MessagesCreateNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title MessagesCreateNonFieldErrorsErrorComponent
#' @description MessagesCreateNonFieldErrorsErrorComponent Class
...
#' @export
MessagesCreateNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MessagesCreateNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return MessagesCreateNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of MessagesCreateNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessagesCreateNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MessagesCreateNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        MessagesCreateNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        MessagesCreateNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        MessagesCreateNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(MessagesCreateNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of MessagesCreateNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of MessagesCreateNonFieldErrorsErrorComponent
    ...
    #' @return MessagesCreateNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MessagesCreateNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MessagesCreateNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MessagesCreateNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MessagesCreateNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of MessagesCreateNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# MessagesCreateNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# MessagesCreateNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MessagesCreateNonFieldErrorsErrorComponent$lock()
