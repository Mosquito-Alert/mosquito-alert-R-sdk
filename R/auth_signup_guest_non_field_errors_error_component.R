#' Create a new AuthSignupGuestNonFieldErrorsErrorComponent
#'
#' @description
#' AuthSignupGuestNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title AuthSignupGuestNonFieldErrorsErrorComponent
#' @description AuthSignupGuestNonFieldErrorsErrorComponent Class
...
#' @export
AuthSignupGuestNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AuthSignupGuestNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return AuthSignupGuestNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of AuthSignupGuestNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AuthSignupGuestNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AuthSignupGuestNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        AuthSignupGuestNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        AuthSignupGuestNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        AuthSignupGuestNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(AuthSignupGuestNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of AuthSignupGuestNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of AuthSignupGuestNonFieldErrorsErrorComponent
    ...
    #' @return AuthSignupGuestNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AuthSignupGuestNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthSignupGuestNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthSignupGuestNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthSignupGuestNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AuthSignupGuestNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# AuthSignupGuestNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# AuthSignupGuestNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AuthSignupGuestNonFieldErrorsErrorComponent$lock()
