#' Create a new FixesCreateNonFieldErrorsErrorComponent
#'
#' @description
#' FixesCreateNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title FixesCreateNonFieldErrorsErrorComponent
#' @description FixesCreateNonFieldErrorsErrorComponent Class
...
#' @export
FixesCreateNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new FixesCreateNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return FixesCreateNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of FixesCreateNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert FixesCreateNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      FixesCreateNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        FixesCreateNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        FixesCreateNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        FixesCreateNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(FixesCreateNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of FixesCreateNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of FixesCreateNonFieldErrorsErrorComponent
    ...
    #' @return FixesCreateNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to FixesCreateNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for FixesCreateNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for FixesCreateNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for FixesCreateNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of FixesCreateNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# FixesCreateNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# FixesCreateNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# FixesCreateNonFieldErrorsErrorComponent$lock()
