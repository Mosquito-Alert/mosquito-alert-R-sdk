#' Create a new BitesListMineCountryIdErrorComponent
#'
#' @description
#' BitesListMineCountryIdErrorComponent Class
#'
#' @docType class
#' @title BitesListMineCountryIdErrorComponent
#' @description BitesListMineCountryIdErrorComponent Class
...
#' @export
BitesListMineCountryIdErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesListMineCountryIdErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesListMineCountryIdErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesListMineCountryIdErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesListMineCountryIdErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesListMineCountryIdErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesListMineCountryIdErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesListMineCountryIdErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesListMineCountryIdErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesListMineCountryIdErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesListMineCountryIdErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesListMineCountryIdErrorComponent
    ...
    #' @return BitesListMineCountryIdErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesListMineCountryIdErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineCountryIdErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineCountryIdErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineCountryIdErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesListMineCountryIdErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesListMineCountryIdErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesListMineCountryIdErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesListMineCountryIdErrorComponent$lock()
