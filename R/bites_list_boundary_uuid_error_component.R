#' Create a new BitesListBoundaryUuidErrorComponent
#'
#' @description
#' BitesListBoundaryUuidErrorComponent Class
#'
#' @docType class
#' @title BitesListBoundaryUuidErrorComponent
#' @description BitesListBoundaryUuidErrorComponent Class
...
#' @export
BitesListBoundaryUuidErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesListBoundaryUuidErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesListBoundaryUuidErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesListBoundaryUuidErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesListBoundaryUuidErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesListBoundaryUuidErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesListBoundaryUuidErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesListBoundaryUuidErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesListBoundaryUuidErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesListBoundaryUuidErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesListBoundaryUuidErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesListBoundaryUuidErrorComponent
    ...
    #' @return BitesListBoundaryUuidErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesListBoundaryUuidErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListBoundaryUuidErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListBoundaryUuidErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListBoundaryUuidErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesListBoundaryUuidErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesListBoundaryUuidErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesListBoundaryUuidErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesListBoundaryUuidErrorComponent$lock()
