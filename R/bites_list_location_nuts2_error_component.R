#' Create a new BitesListLocationNuts2ErrorComponent
#'
#' @description
#' BitesListLocationNuts2ErrorComponent Class
#'
#' @docType class
#' @title BitesListLocationNuts2ErrorComponent
#' @description BitesListLocationNuts2ErrorComponent Class
...
#' @export
BitesListLocationNuts2ErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesListLocationNuts2ErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesListLocationNuts2ErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesListLocationNuts2ErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesListLocationNuts2ErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesListLocationNuts2ErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesListLocationNuts2ErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesListLocationNuts2ErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesListLocationNuts2ErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesListLocationNuts2ErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesListLocationNuts2ErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesListLocationNuts2ErrorComponent
    ...
    #' @return BitesListLocationNuts2ErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesListLocationNuts2ErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListLocationNuts2ErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListLocationNuts2ErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListLocationNuts2ErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesListLocationNuts2ErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesListLocationNuts2ErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesListLocationNuts2ErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesListLocationNuts2ErrorComponent$lock()
