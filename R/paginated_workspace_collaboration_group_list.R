#' Create a new PaginatedWorkspaceCollaborationGroupList
#'
#' @description
#' PaginatedWorkspaceCollaborationGroupList Class
#'
#' @docType class
#' @title PaginatedWorkspaceCollaborationGroupList
#' @description PaginatedWorkspaceCollaborationGroupList Class
#' @format An \code{R6Class} generator object
#' @field count  integer
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{WorkspaceCollaborationGroup})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedWorkspaceCollaborationGroupList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedWorkspaceCollaborationGroupList class.
    #'
    #' @param count count
    ...
    #'
    #' @return PaginatedWorkspaceCollaborationGroupList as a base R list.
    #' @examples
    #' # convert array of PaginatedWorkspaceCollaborationGroupList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedWorkspaceCollaborationGroupList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedWorkspaceCollaborationGroupListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedWorkspaceCollaborationGroupListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedWorkspaceCollaborationGroupListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedWorkspaceCollaborationGroupListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedWorkspaceCollaborationGroupListObject[["results"]] <-
          self$extractSimpleType(self$`results`)
      }
      return(PaginatedWorkspaceCollaborationGroupListObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of PaginatedWorkspaceCollaborationGroupList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedWorkspaceCollaborationGroupList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[WorkspaceCollaborationGroup]", loadNamespace("MosquitoAlert"))
      }
      self
    },
    ...
    #' @return PaginatedWorkspaceCollaborationGroupList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedWorkspaceCollaborationGroupList and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PaginatedWorkspaceCollaborationGroupList: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`results`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PaginatedWorkspaceCollaborationGroupList: the required field `results` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PaginatedWorkspaceCollaborationGroupList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedWorkspaceCollaborationGroupList$unlock()
#
## Below is an example to define the print function
# PaginatedWorkspaceCollaborationGroupList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedWorkspaceCollaborationGroupList$lock()
