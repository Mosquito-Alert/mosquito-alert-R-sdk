#' Create a new LocalizedMessageTitle
#'
#' @description
...
#' @description LocalizedMessageTitle Class
...
#' @export
LocalizedMessageTitle <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LocalizedMessageTitle class.
    #'
    #' @param en English
    #' @param bg Български
    #' @param bn বাংলা
    ...
    #'
    #' @return LocalizedMessageTitle as a base R list.
    #' @examples
    #' # convert array of LocalizedMessageTitle (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LocalizedMessageTitle to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LocalizedMessageTitleObject <- list()
      if (!is.null(self$`bg`)) {
        LocalizedMessageTitleObject[["bg"]] <-
          self$`bg`
      }
      if (!is.null(self$`bn`)) {
        LocalizedMessageTitleObject[["bn"]] <-
          self$`bn`
      }
      if (!is.null(self$`ca`)) {
        LocalizedMessageTitleObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`de`)) {
        LocalizedMessageTitleObject[["de"]] <-
          self$`de`
      }
      if (!is.null(self$`el`)) {
        LocalizedMessageTitleObject[["el"]] <-
          self$`el`
      }
      if (!is.null(self$`en`)) {
        LocalizedMessageTitleObject[["en"]] <-
          self$`en`
      }
      if (!is.null(self$`es`)) {
        LocalizedMessageTitleObject[["es"]] <-
          self$`es`
      }
      if (!is.null(self$`eu`)) {
        LocalizedMessageTitleObject[["eu"]] <-
          self$`eu`
      }
      if (!is.null(self$`fr`)) {
        LocalizedMessageTitleObject[["fr"]] <-
          self$`fr`
      }
      if (!is.null(self$`gl`)) {
        LocalizedMessageTitleObject[["gl"]] <-
          self$`gl`
      }
      if (!is.null(self$`hr`)) {
        LocalizedMessageTitleObject[["hr"]] <-
          self$`hr`
      }
      if (!is.null(self$`hu`)) {
        LocalizedMessageTitleObject[["hu"]] <-
          self$`hu`
      }
      if (!is.null(self$`it`)) {
        LocalizedMessageTitleObject[["it"]] <-
          self$`it`
      }
      if (!is.null(self$`lb`)) {
        LocalizedMessageTitleObject[["lb"]] <-
          self$`lb`
      }
      if (!is.null(self$`mk`)) {
        LocalizedMessageTitleObject[["mk"]] <-
          self$`mk`
      }
      if (!is.null(self$`nl`)) {
        LocalizedMessageTitleObject[["nl"]] <-
          self$`nl`
      }
      if (!is.null(self$`pt`)) {
        LocalizedMessageTitleObject[["pt"]] <-
          self$`pt`
      }
      if (!is.null(self$`ro`)) {
        LocalizedMessageTitleObject[["ro"]] <-
          self$`ro`
      }
      if (!is.null(self$`sl`)) {
        LocalizedMessageTitleObject[["sl"]] <-
          self$`sl`
      }
      if (!is.null(self$`sq`)) {
        LocalizedMessageTitleObject[["sq"]] <-
          self$`sq`
      }
      if (!is.null(self$`sr`)) {
        LocalizedMessageTitleObject[["sr"]] <-
          self$`sr`
      }
      if (!is.null(self$`sv`)) {
        LocalizedMessageTitleObject[["sv"]] <-
          self$`sv`
      }
      if (!is.null(self$`tr`)) {
        LocalizedMessageTitleObject[["tr"]] <-
          self$`tr`
      }
      if (!is.null(self$`zh-CN`)) {
        LocalizedMessageTitleObject[["zh-CN"]] <-
          self$`zh-CN`
      }
      return(LocalizedMessageTitleObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LocalizedMessageTitle
    #'
    #' @param input_json the JSON input
    #' @return the instance of LocalizedMessageTitle
    ...
    #' @return LocalizedMessageTitle in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LocalizedMessageTitle and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`en`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalizedMessageTitle: the required field `en` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LocalizedMessageTitle
    toString = function() {
      self$toJSONString()
    },
...
# LocalizedMessageTitle$unlock()
#
## Below is an example to define the print function
# LocalizedMessageTitle$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LocalizedMessageTitle$lock()
