#' Create a new BitesListCountryIdErrorComponent
#'
#' @description
#' BitesListCountryIdErrorComponent Class
#'
#' @docType class
#' @title BitesListCountryIdErrorComponent
#' @description BitesListCountryIdErrorComponent Class
...
#' @export
BitesListCountryIdErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesListCountryIdErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesListCountryIdErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesListCountryIdErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesListCountryIdErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesListCountryIdErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesListCountryIdErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesListCountryIdErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesListCountryIdErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesListCountryIdErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesListCountryIdErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesListCountryIdErrorComponent
    ...
    #' @return BitesListCountryIdErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesListCountryIdErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListCountryIdErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListCountryIdErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListCountryIdErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesListCountryIdErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesListCountryIdErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesListCountryIdErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesListCountryIdErrorComponent$lock()
