...
FixLocationRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return FixLocationRequest as a base R list.
    #' @examples
    #' # convert array of FixLocationRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert FixLocationRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(FixLocationRequestObject)
    },
