#' Create a new ObservationsCreateNonFieldErrorsErrorComponent
#'
#' @description
#' ObservationsCreateNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title ObservationsCreateNonFieldErrorsErrorComponent
#' @description ObservationsCreateNonFieldErrorsErrorComponent Class
...
#' @export
ObservationsCreateNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsCreateNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsCreateNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsCreateNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsCreateNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsCreateNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsCreateNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsCreateNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsCreateNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsCreateNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsCreateNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsCreateNonFieldErrorsErrorComponent
    ...
    #' @return ObservationsCreateNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsCreateNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsCreateNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsCreateNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsCreateNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsCreateNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsCreateNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsCreateNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsCreateNonFieldErrorsErrorComponent$lock()
