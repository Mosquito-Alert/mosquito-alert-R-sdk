#' Create a new BitesListMineLocationNuts2ErrorComponent
#'
#' @description
#' BitesListMineLocationNuts2ErrorComponent Class
#'
#' @docType class
#' @title BitesListMineLocationNuts2ErrorComponent
#' @description BitesListMineLocationNuts2ErrorComponent Class
...
#' @export
BitesListMineLocationNuts2ErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesListMineLocationNuts2ErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesListMineLocationNuts2ErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesListMineLocationNuts2ErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesListMineLocationNuts2ErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesListMineLocationNuts2ErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesListMineLocationNuts2ErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesListMineLocationNuts2ErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesListMineLocationNuts2ErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesListMineLocationNuts2ErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesListMineLocationNuts2ErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesListMineLocationNuts2ErrorComponent
    ...
    #' @return BitesListMineLocationNuts2ErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesListMineLocationNuts2ErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineLocationNuts2ErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineLocationNuts2ErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineLocationNuts2ErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesListMineLocationNuts2ErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesListMineLocationNuts2ErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesListMineLocationNuts2ErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesListMineLocationNuts2ErrorComponent$lock()
