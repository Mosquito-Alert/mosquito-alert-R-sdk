  ...
  public = list(
    ...
    list_with_http_info = function(country_id = NULL, is_active = NULL, order_by = NULL, page = NULL, page_size = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "PaginatedCampaignList", loadNamespace("MosquitoAlert")),
          error = function(e) {
    ...
    retrieve_with_http_info = function(id, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "Campaign", loadNamespace("MosquitoAlert")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
