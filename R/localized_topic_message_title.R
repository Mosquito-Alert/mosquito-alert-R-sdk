#' Create a new LocalizedTopicMessageTitle
#'
#' @description
...
#'
#' @docType class
#' @title LocalizedTopicMessageTitle
#' @description LocalizedTopicMessageTitle Class
...
#' @export
LocalizedTopicMessageTitle <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LocalizedTopicMessageTitle class.
    #'
    #' @param en English
    #' @param bg Български
    #' @param bn বাংলা
    ...
    #'
    #' @return LocalizedTopicMessageTitle as a base R list.
    #' @examples
    #' # convert array of LocalizedTopicMessageTitle (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LocalizedTopicMessageTitle to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LocalizedTopicMessageTitleObject <- list()
      if (!is.null(self$`bg`)) {
        LocalizedTopicMessageTitleObject[["bg"]] <-
          self$`bg`
      }
      if (!is.null(self$`bn`)) {
        LocalizedTopicMessageTitleObject[["bn"]] <-
          self$`bn`
      }
      if (!is.null(self$`ca`)) {
        LocalizedTopicMessageTitleObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`de`)) {
        LocalizedTopicMessageTitleObject[["de"]] <-
          self$`de`
      }
      if (!is.null(self$`el`)) {
        LocalizedTopicMessageTitleObject[["el"]] <-
          self$`el`
      }
      if (!is.null(self$`en`)) {
        LocalizedTopicMessageTitleObject[["en"]] <-
          self$`en`
      }
      if (!is.null(self$`es`)) {
        LocalizedTopicMessageTitleObject[["es"]] <-
          self$`es`
      }
      if (!is.null(self$`eu`)) {
        LocalizedTopicMessageTitleObject[["eu"]] <-
          self$`eu`
      }
      if (!is.null(self$`fr`)) {
        LocalizedTopicMessageTitleObject[["fr"]] <-
          self$`fr`
      }
      if (!is.null(self$`gl`)) {
        LocalizedTopicMessageTitleObject[["gl"]] <-
          self$`gl`
      }
      if (!is.null(self$`hr`)) {
        LocalizedTopicMessageTitleObject[["hr"]] <-
          self$`hr`
      }
      if (!is.null(self$`hu`)) {
        LocalizedTopicMessageTitleObject[["hu"]] <-
          self$`hu`
      }
      if (!is.null(self$`it`)) {
        LocalizedTopicMessageTitleObject[["it"]] <-
          self$`it`
      }
      if (!is.null(self$`lb`)) {
        LocalizedTopicMessageTitleObject[["lb"]] <-
          self$`lb`
      }
      if (!is.null(self$`mk`)) {
        LocalizedTopicMessageTitleObject[["mk"]] <-
          self$`mk`
      }
      if (!is.null(self$`nl`)) {
        LocalizedTopicMessageTitleObject[["nl"]] <-
          self$`nl`
      }
      if (!is.null(self$`pt`)) {
        LocalizedTopicMessageTitleObject[["pt"]] <-
          self$`pt`
      }
      if (!is.null(self$`ro`)) {
        LocalizedTopicMessageTitleObject[["ro"]] <-
          self$`ro`
      }
      if (!is.null(self$`sl`)) {
        LocalizedTopicMessageTitleObject[["sl"]] <-
          self$`sl`
      }
      if (!is.null(self$`sq`)) {
        LocalizedTopicMessageTitleObject[["sq"]] <-
          self$`sq`
      }
      if (!is.null(self$`sr`)) {
        LocalizedTopicMessageTitleObject[["sr"]] <-
          self$`sr`
      }
      if (!is.null(self$`sv`)) {
        LocalizedTopicMessageTitleObject[["sv"]] <-
          self$`sv`
      }
      if (!is.null(self$`tr`)) {
        LocalizedTopicMessageTitleObject[["tr"]] <-
          self$`tr`
      }
      if (!is.null(self$`zh-cn`)) {
        LocalizedTopicMessageTitleObject[["zh-cn"]] <-
          self$`zh-cn`
      }
      return(LocalizedTopicMessageTitleObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LocalizedTopicMessageTitle
    #'
    #' @param input_json the JSON input
    #' @return the instance of LocalizedTopicMessageTitle
    ...
    #' @return LocalizedTopicMessageTitle in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LocalizedTopicMessageTitle and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`en`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalizedTopicMessageTitle: the required field `en` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LocalizedTopicMessageTitle
    toString = function() {
      self$toJSONString()
    },
...
# LocalizedTopicMessageTitle$unlock()
#
## Below is an example to define the print function
# LocalizedTopicMessageTitle$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LocalizedTopicMessageTitle$lock()
