#' Create a new AuthChangePasswordNonFieldErrorsErrorComponent
#'
#' @description
#' AuthChangePasswordNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title AuthChangePasswordNonFieldErrorsErrorComponent
#' @description AuthChangePasswordNonFieldErrorsErrorComponent Class
...
#' @export
AuthChangePasswordNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AuthChangePasswordNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return AuthChangePasswordNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of AuthChangePasswordNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AuthChangePasswordNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AuthChangePasswordNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        AuthChangePasswordNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        AuthChangePasswordNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        AuthChangePasswordNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(AuthChangePasswordNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of AuthChangePasswordNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of AuthChangePasswordNonFieldErrorsErrorComponent
    ...
    #' @return AuthChangePasswordNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AuthChangePasswordNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthChangePasswordNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthChangePasswordNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthChangePasswordNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AuthChangePasswordNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# AuthChangePasswordNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# AuthChangePasswordNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AuthChangePasswordNonFieldErrorsErrorComponent$lock()
