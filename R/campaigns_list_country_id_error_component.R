#' Create a new CampaignsListCountryIdErrorComponent
#'
#' @description
#' CampaignsListCountryIdErrorComponent Class
#'
#' @docType class
#' @title CampaignsListCountryIdErrorComponent
#' @description CampaignsListCountryIdErrorComponent Class
...
#' @export
CampaignsListCountryIdErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CampaignsListCountryIdErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return CampaignsListCountryIdErrorComponent as a base R list.
    #' @examples
    #' # convert array of CampaignsListCountryIdErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CampaignsListCountryIdErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CampaignsListCountryIdErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        CampaignsListCountryIdErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        CampaignsListCountryIdErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        CampaignsListCountryIdErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(CampaignsListCountryIdErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of CampaignsListCountryIdErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of CampaignsListCountryIdErrorComponent
    ...
    #' @return CampaignsListCountryIdErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CampaignsListCountryIdErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CampaignsListCountryIdErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CampaignsListCountryIdErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CampaignsListCountryIdErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CampaignsListCountryIdErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# CampaignsListCountryIdErrorComponent$unlock()
#
## Below is an example to define the print function
# CampaignsListCountryIdErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CampaignsListCountryIdErrorComponent$lock()
