#' Create a new BitesListReceivedAtErrorComponent
#'
#' @description
#' BitesListReceivedAtErrorComponent Class
#'
#' @docType class
#' @title BitesListReceivedAtErrorComponent
#' @description BitesListReceivedAtErrorComponent Class
...
#' @export
BitesListReceivedAtErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesListReceivedAtErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesListReceivedAtErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesListReceivedAtErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesListReceivedAtErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesListReceivedAtErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesListReceivedAtErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesListReceivedAtErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesListReceivedAtErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesListReceivedAtErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesListReceivedAtErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesListReceivedAtErrorComponent
    ...
    #' @return BitesListReceivedAtErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesListReceivedAtErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListReceivedAtErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListReceivedAtErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListReceivedAtErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesListReceivedAtErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesListReceivedAtErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesListReceivedAtErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesListReceivedAtErrorComponent$lock()
