#' Create a new UsersPartialUpdateNonFieldErrorsErrorComponent
#'
#' @description
#' UsersPartialUpdateNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title UsersPartialUpdateNonFieldErrorsErrorComponent
#' @description UsersPartialUpdateNonFieldErrorsErrorComponent Class
...
#' @export
UsersPartialUpdateNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new UsersPartialUpdateNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return UsersPartialUpdateNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of UsersPartialUpdateNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UsersPartialUpdateNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      UsersPartialUpdateNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        UsersPartialUpdateNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        UsersPartialUpdateNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        UsersPartialUpdateNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(UsersPartialUpdateNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of UsersPartialUpdateNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of UsersPartialUpdateNonFieldErrorsErrorComponent
    ...
    #' @return UsersPartialUpdateNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to UsersPartialUpdateNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersPartialUpdateNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersPartialUpdateNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersPartialUpdateNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of UsersPartialUpdateNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# UsersPartialUpdateNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# UsersPartialUpdateNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UsersPartialUpdateNonFieldErrorsErrorComponent$lock()
