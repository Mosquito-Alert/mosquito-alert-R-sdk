#' Create a new LocalizedTopicMessageBodyRequest
#'
#' @description
...
#'
#' @docType class
#' @title LocalizedTopicMessageBodyRequest
#' @description LocalizedTopicMessageBodyRequest Class
...
#' @export
LocalizedTopicMessageBodyRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LocalizedTopicMessageBodyRequest class.
    #'
    #' @param en English
    #' @param bg Български
    #' @param bn বাংলা
    ...
    #'
    #' @return LocalizedTopicMessageBodyRequest as a base R list.
    #' @examples
    #' # convert array of LocalizedTopicMessageBodyRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LocalizedTopicMessageBodyRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LocalizedTopicMessageBodyRequestObject <- list()
      if (!is.null(self$`bg`)) {
        LocalizedTopicMessageBodyRequestObject[["bg"]] <-
          self$`bg`
      }
      if (!is.null(self$`bn`)) {
        LocalizedTopicMessageBodyRequestObject[["bn"]] <-
          self$`bn`
      }
      if (!is.null(self$`ca`)) {
        LocalizedTopicMessageBodyRequestObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`de`)) {
        LocalizedTopicMessageBodyRequestObject[["de"]] <-
          self$`de`
      }
      if (!is.null(self$`el`)) {
        LocalizedTopicMessageBodyRequestObject[["el"]] <-
          self$`el`
      }
      if (!is.null(self$`en`)) {
        LocalizedTopicMessageBodyRequestObject[["en"]] <-
          self$`en`
      }
      if (!is.null(self$`es`)) {
        LocalizedTopicMessageBodyRequestObject[["es"]] <-
          self$`es`
      }
      if (!is.null(self$`eu`)) {
        LocalizedTopicMessageBodyRequestObject[["eu"]] <-
          self$`eu`
      }
      if (!is.null(self$`fr`)) {
        LocalizedTopicMessageBodyRequestObject[["fr"]] <-
          self$`fr`
      }
      if (!is.null(self$`gl`)) {
        LocalizedTopicMessageBodyRequestObject[["gl"]] <-
          self$`gl`
      }
      if (!is.null(self$`hr`)) {
        LocalizedTopicMessageBodyRequestObject[["hr"]] <-
          self$`hr`
      }
      if (!is.null(self$`hu`)) {
        LocalizedTopicMessageBodyRequestObject[["hu"]] <-
          self$`hu`
      }
      if (!is.null(self$`it`)) {
        LocalizedTopicMessageBodyRequestObject[["it"]] <-
          self$`it`
      }
      if (!is.null(self$`lb`)) {
        LocalizedTopicMessageBodyRequestObject[["lb"]] <-
          self$`lb`
      }
      if (!is.null(self$`mk`)) {
        LocalizedTopicMessageBodyRequestObject[["mk"]] <-
          self$`mk`
      }
      if (!is.null(self$`nl`)) {
        LocalizedTopicMessageBodyRequestObject[["nl"]] <-
          self$`nl`
      }
      if (!is.null(self$`pt`)) {
        LocalizedTopicMessageBodyRequestObject[["pt"]] <-
          self$`pt`
      }
      if (!is.null(self$`ro`)) {
        LocalizedTopicMessageBodyRequestObject[["ro"]] <-
          self$`ro`
      }
      if (!is.null(self$`sl`)) {
        LocalizedTopicMessageBodyRequestObject[["sl"]] <-
          self$`sl`
      }
      if (!is.null(self$`sq`)) {
        LocalizedTopicMessageBodyRequestObject[["sq"]] <-
          self$`sq`
      }
      if (!is.null(self$`sr`)) {
        LocalizedTopicMessageBodyRequestObject[["sr"]] <-
          self$`sr`
      }
      if (!is.null(self$`sv`)) {
        LocalizedTopicMessageBodyRequestObject[["sv"]] <-
          self$`sv`
      }
      if (!is.null(self$`tr`)) {
        LocalizedTopicMessageBodyRequestObject[["tr"]] <-
          self$`tr`
      }
      if (!is.null(self$`zh-CN`)) {
        LocalizedTopicMessageBodyRequestObject[["zh-CN"]] <-
          self$`zh-CN`
      }
      return(LocalizedTopicMessageBodyRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LocalizedTopicMessageBodyRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of LocalizedTopicMessageBodyRequest
    ...
    #' @return LocalizedTopicMessageBodyRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LocalizedTopicMessageBodyRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`en`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalizedTopicMessageBodyRequest: the required field `en` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LocalizedTopicMessageBodyRequest
    toString = function() {
      self$toJSONString()
    },
...
# LocalizedTopicMessageBodyRequest$unlock()
#
## Below is an example to define the print function
# LocalizedTopicMessageBodyRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LocalizedTopicMessageBodyRequest$lock()
