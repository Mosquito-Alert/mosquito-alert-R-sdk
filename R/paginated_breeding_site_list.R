...
PaginatedBreedingSiteList <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return PaginatedBreedingSiteList as a base R list.
    #' @examples
    #' # convert array of PaginatedBreedingSiteList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedBreedingSiteList to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(PaginatedBreedingSiteListObject)
    },
