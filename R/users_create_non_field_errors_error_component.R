#' Create a new UsersCreateNonFieldErrorsErrorComponent
#'
#' @description
#' UsersCreateNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title UsersCreateNonFieldErrorsErrorComponent
#' @description UsersCreateNonFieldErrorsErrorComponent Class
...
#' @export
UsersCreateNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new UsersCreateNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #' To JSON String
    #'
    #' @return UsersCreateNonFieldErrorsErrorComponent in JSON format
    toJSON = function() {
      UsersCreateNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        UsersCreateNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        UsersCreateNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        UsersCreateNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      UsersCreateNonFieldErrorsErrorComponentObject
    },

    #' @description
    #' Deserialize JSON string into an instance of UsersCreateNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of UsersCreateNonFieldErrorsErrorComponent
    ...
    #' @description
    #' Validate JSON input with respect to UsersCreateNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersCreateNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersCreateNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersCreateNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of UsersCreateNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# UsersCreateNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# UsersCreateNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UsersCreateNonFieldErrorsErrorComponent$lock()
