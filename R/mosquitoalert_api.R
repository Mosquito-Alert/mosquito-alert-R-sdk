...
#' @field boundaries_api an instance of BoundariesApi
...
#' @field messages_api an instance of MessagesApi
...
mosquitoalert_api <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(api_client) {
      ...
      self$boundaries_api <- BoundariesApi$new(self$api_client)
      ...
      self$messages_api <- MessagesApi$new(self$api_client)
