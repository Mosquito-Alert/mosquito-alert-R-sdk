#' Create a new BitesGeoListBoundaryUuidErrorComponent
#'
#' @description
#' BitesGeoListBoundaryUuidErrorComponent Class
#'
#' @docType class
#' @title BitesGeoListBoundaryUuidErrorComponent
#' @description BitesGeoListBoundaryUuidErrorComponent Class
...
#' @export
BitesGeoListBoundaryUuidErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesGeoListBoundaryUuidErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesGeoListBoundaryUuidErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesGeoListBoundaryUuidErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesGeoListBoundaryUuidErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesGeoListBoundaryUuidErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesGeoListBoundaryUuidErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesGeoListBoundaryUuidErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesGeoListBoundaryUuidErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesGeoListBoundaryUuidErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesGeoListBoundaryUuidErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesGeoListBoundaryUuidErrorComponent
    ...
    #' @return BitesGeoListBoundaryUuidErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesGeoListBoundaryUuidErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesGeoListBoundaryUuidErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesGeoListBoundaryUuidErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesGeoListBoundaryUuidErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesGeoListBoundaryUuidErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesGeoListBoundaryUuidErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesGeoListBoundaryUuidErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesGeoListBoundaryUuidErrorComponent$lock()
