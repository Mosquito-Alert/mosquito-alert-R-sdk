#' Create a new BitesListTagsErrorComponent
#'
#' @description
#' BitesListTagsErrorComponent Class
#'
#' @docType class
#' @title BitesListTagsErrorComponent
#' @description BitesListTagsErrorComponent Class
...
#' @export
BitesListTagsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesListTagsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesListTagsErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesListTagsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesListTagsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesListTagsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesListTagsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesListTagsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesListTagsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesListTagsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesListTagsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesListTagsErrorComponent
    ...
    #' @return BitesListTagsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesListTagsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListTagsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListTagsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListTagsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesListTagsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesListTagsErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesListTagsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesListTagsErrorComponent$lock()
