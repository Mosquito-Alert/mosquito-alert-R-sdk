#' Create a new ObservationsListMineCountryIdErrorComponent
#'
#' @description
#' ObservationsListMineCountryIdErrorComponent Class
#'
#' @docType class
#' @title ObservationsListMineCountryIdErrorComponent
#' @description ObservationsListMineCountryIdErrorComponent Class
...
#' @export
ObservationsListMineCountryIdErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsListMineCountryIdErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsListMineCountryIdErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsListMineCountryIdErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsListMineCountryIdErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsListMineCountryIdErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsListMineCountryIdErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsListMineCountryIdErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsListMineCountryIdErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsListMineCountryIdErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsListMineCountryIdErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsListMineCountryIdErrorComponent
    ...
    #' @return ObservationsListMineCountryIdErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsListMineCountryIdErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineCountryIdErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineCountryIdErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineCountryIdErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsListMineCountryIdErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsListMineCountryIdErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsListMineCountryIdErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsListMineCountryIdErrorComponent$lock()
