#' Create a new ObservationsListBoundaryUuidErrorComponent
#'
#' @description
#' ObservationsListBoundaryUuidErrorComponent Class
#'
#' @docType class
#' @title ObservationsListBoundaryUuidErrorComponent
#' @description ObservationsListBoundaryUuidErrorComponent Class
...
#' @export
ObservationsListBoundaryUuidErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsListBoundaryUuidErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsListBoundaryUuidErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsListBoundaryUuidErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsListBoundaryUuidErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsListBoundaryUuidErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsListBoundaryUuidErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsListBoundaryUuidErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsListBoundaryUuidErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsListBoundaryUuidErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsListBoundaryUuidErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsListBoundaryUuidErrorComponent
    ...
    #' @return ObservationsListBoundaryUuidErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsListBoundaryUuidErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListBoundaryUuidErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListBoundaryUuidErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListBoundaryUuidErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsListBoundaryUuidErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsListBoundaryUuidErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsListBoundaryUuidErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsListBoundaryUuidErrorComponent$lock()
