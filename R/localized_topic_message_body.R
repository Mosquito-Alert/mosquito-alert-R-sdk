#' Create a new LocalizedTopicMessageBody
#'
#' @description
...
#'
#' @docType class
#' @title LocalizedTopicMessageBody
#' @description LocalizedTopicMessageBody Class
...
#' @export
LocalizedTopicMessageBody <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LocalizedTopicMessageBody class.
    #'
    #' @param en English
    #' @param bg Български
    #' @param bn বাংলা
    ...
    #'
    #' @return LocalizedTopicMessageBody as a base R list.
    #' @examples
    #' # convert array of LocalizedTopicMessageBody (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LocalizedTopicMessageBody to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LocalizedTopicMessageBodyObject <- list()
      if (!is.null(self$`bg`)) {
        LocalizedTopicMessageBodyObject[["bg"]] <-
          self$`bg`
      }
      if (!is.null(self$`bn`)) {
        LocalizedTopicMessageBodyObject[["bn"]] <-
          self$`bn`
      }
      if (!is.null(self$`ca`)) {
        LocalizedTopicMessageBodyObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`de`)) {
        LocalizedTopicMessageBodyObject[["de"]] <-
          self$`de`
      }
      if (!is.null(self$`el`)) {
        LocalizedTopicMessageBodyObject[["el"]] <-
          self$`el`
      }
      if (!is.null(self$`en`)) {
        LocalizedTopicMessageBodyObject[["en"]] <-
          self$`en`
      }
      if (!is.null(self$`es`)) {
        LocalizedTopicMessageBodyObject[["es"]] <-
          self$`es`
      }
      if (!is.null(self$`eu`)) {
        LocalizedTopicMessageBodyObject[["eu"]] <-
          self$`eu`
      }
      if (!is.null(self$`fr`)) {
        LocalizedTopicMessageBodyObject[["fr"]] <-
          self$`fr`
      }
      if (!is.null(self$`gl`)) {
        LocalizedTopicMessageBodyObject[["gl"]] <-
          self$`gl`
      }
      if (!is.null(self$`hr`)) {
        LocalizedTopicMessageBodyObject[["hr"]] <-
          self$`hr`
      }
      if (!is.null(self$`hu`)) {
        LocalizedTopicMessageBodyObject[["hu"]] <-
          self$`hu`
      }
      if (!is.null(self$`it`)) {
        LocalizedTopicMessageBodyObject[["it"]] <-
          self$`it`
      }
      if (!is.null(self$`lb`)) {
        LocalizedTopicMessageBodyObject[["lb"]] <-
          self$`lb`
      }
      if (!is.null(self$`mk`)) {
        LocalizedTopicMessageBodyObject[["mk"]] <-
          self$`mk`
      }
      if (!is.null(self$`nl`)) {
        LocalizedTopicMessageBodyObject[["nl"]] <-
          self$`nl`
      }
      if (!is.null(self$`pt`)) {
        LocalizedTopicMessageBodyObject[["pt"]] <-
          self$`pt`
      }
      if (!is.null(self$`ro`)) {
        LocalizedTopicMessageBodyObject[["ro"]] <-
          self$`ro`
      }
      if (!is.null(self$`sl`)) {
        LocalizedTopicMessageBodyObject[["sl"]] <-
          self$`sl`
      }
      if (!is.null(self$`sq`)) {
        LocalizedTopicMessageBodyObject[["sq"]] <-
          self$`sq`
      }
      if (!is.null(self$`sr`)) {
        LocalizedTopicMessageBodyObject[["sr"]] <-
          self$`sr`
      }
      if (!is.null(self$`sv`)) {
        LocalizedTopicMessageBodyObject[["sv"]] <-
          self$`sv`
      }
      if (!is.null(self$`tr`)) {
        LocalizedTopicMessageBodyObject[["tr"]] <-
          self$`tr`
      }
      if (!is.null(self$`zh-cn`)) {
        LocalizedTopicMessageBodyObject[["zh-cn"]] <-
          self$`zh-cn`
      }
      return(LocalizedTopicMessageBodyObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LocalizedTopicMessageBody
    #'
    #' @param input_json the JSON input
    #' @return the instance of LocalizedTopicMessageBody
    ...
    #' @return LocalizedTopicMessageBody in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LocalizedTopicMessageBody and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`en`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalizedTopicMessageBody: the required field `en` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LocalizedTopicMessageBody
    toString = function() {
      self$toJSONString()
    },
...
# LocalizedTopicMessageBody$unlock()
#
## Below is an example to define the print function
# LocalizedTopicMessageBody$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LocalizedTopicMessageBody$lock()
