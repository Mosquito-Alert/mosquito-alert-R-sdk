#' Create a new UsersUpdateNonFieldErrorsErrorComponent
#'
#' @description
#' UsersUpdateNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title UsersUpdateNonFieldErrorsErrorComponent
#' @description UsersUpdateNonFieldErrorsErrorComponent Class
...
#' @export
UsersUpdateNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new UsersUpdateNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return UsersUpdateNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of UsersUpdateNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UsersUpdateNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      UsersUpdateNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        UsersUpdateNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        UsersUpdateNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        UsersUpdateNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(UsersUpdateNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of UsersUpdateNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of UsersUpdateNonFieldErrorsErrorComponent
    ...
    #' @return UsersUpdateNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to UsersUpdateNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersUpdateNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersUpdateNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersUpdateNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of UsersUpdateNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# UsersUpdateNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# UsersUpdateNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UsersUpdateNonFieldErrorsErrorComponent$lock()
