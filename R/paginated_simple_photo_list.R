#' Create a new PaginatedSimplePhotoList
#'
#' @description
#' PaginatedSimplePhotoList Class
#'
#' @docType class
#' @title PaginatedSimplePhotoList
#' @description PaginatedSimplePhotoList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{SimplePhoto}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedSimplePhotoList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedSimplePhotoList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedSimplePhotoList as a base R list.
    #' @examples
    #' # convert array of PaginatedSimplePhotoList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedSimplePhotoList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedSimplePhotoListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedSimplePhotoListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedSimplePhotoListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedSimplePhotoListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedSimplePhotoListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedSimplePhotoListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedSimplePhotoList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedSimplePhotoList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[SimplePhoto]", loadNamespace("MosquitoAlert"))
      }
      self
    },
    ...
    #' @return PaginatedSimplePhotoList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedSimplePhotoList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedSimplePhotoList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedSimplePhotoList$unlock()
#
## Below is an example to define the print function
# PaginatedSimplePhotoList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedSimplePhotoList$lock()
