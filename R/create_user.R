...
CreateUser <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CreateUser class.
    #'
    #' @param uuid uuid
    ...
    #' To JSON String
    #'
    #' @return CreateUser in JSON format
    toJSON = function() {
      ...
      if (!is.null(self$`registration_time`)) {
        CreateUserObject[["registration_time"]] <-
          self$`registration_time`
      }
      if (!is.null(self$`locale`)) {
        CreateUserObject[["locale"]] <-
          self$`locale`
      }
      if (!is.null(self$`language_iso`)) {
        CreateUserObject[["language_iso"]] <-
          self$`language_iso`
      }
      if (!is.null(self$`score`)) {
        CreateUserObject[["score"]] <-
          self$`score`
      }
      if (!is.null(self$`last_score_update`)) {
        CreateUserObject[["last_score_update"]] <-
    ...
    #' @description
    #' Deserialize JSON string into an instance of CreateUser
    #'
    #' @param input_json the JSON input
    #' @return the instance of CreateUser
    ...
    #' @description
    #' Validate JSON input with respect to CreateUser and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`uuid`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateUser: the required field `uuid` is missing."))
      }
      ...
      if (!is.null(input_json$`registration_time`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateUser: the required field `registration_time` is missing."))
      }
      ...
      if (!is.null(input_json$`language_iso`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateUser: the required field `language_iso` is missing."))
      }
      ...
      if (!is.null(input_json$`score`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateUser: the required field `score` is missing."))
      }
      ...
      if (!is.null(input_json$`last_score_update`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateUser: the required field `last_score_update` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CreateUser
    toString = function() {
      self$toJSONString()
    },
...
# CreateUser$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
