#' Create a new SimplifiedObservation
#'
#' @description
#' SimplifiedObservation Class
#'
#' @docType class
#' @title SimplifiedObservation
#' @description SimplifiedObservation Class
...
#' @export
SimplifiedObservation <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new SimplifiedObservation class.
    #'
    #' @param uuid uuid
    ...
    initialize = function(`uuid`, `user_uuid`, `created_at`, `created_at_local`, `received_at`, `location`, `note` = NULL, ...) {
      if (!missing(`uuid`)) {
    ...
    #'
    #' @return SimplifiedObservation as a base R list.
    #' @examples
    #' # convert array of SimplifiedObservation (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SimplifiedObservation to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SimplifiedObservationObject <- list()
      if (!is.null(self$`uuid`)) {
        SimplifiedObservationObject[["uuid"]] <-
          self$`uuid`
      }
      if (!is.null(self$`user_uuid`)) {
        SimplifiedObservationObject[["user_uuid"]] <-
          self$`user_uuid`
      }
      if (!is.null(self$`created_at`)) {
        SimplifiedObservationObject[["created_at"]] <-
          self$`created_at`
      }
      if (!is.null(self$`created_at_local`)) {
        SimplifiedObservationObject[["created_at_local"]] <-
          self$`created_at_local`
      }
      if (!is.null(self$`received_at`)) {
        SimplifiedObservationObject[["received_at"]] <-
          self$`received_at`
      }
      if (!is.null(self$`location`)) {
        SimplifiedObservationObject[["location"]] <-
          self$`location`$toSimpleType()
      }
      if (!is.null(self$`note`)) {
        SimplifiedObservationObject[["note"]] <-
          self$`note`
      }
      return(SimplifiedObservationObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of SimplifiedObservation
    #'
    #' @param input_json the JSON input
    #' @return the instance of SimplifiedObservation
    ...
    #' @return SimplifiedObservation in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to SimplifiedObservation and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`uuid`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SimplifiedObservation: the required field `uuid` is missing."))
      }
      ...
      if (!is.null(input_json$`user_uuid`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SimplifiedObservation: the required field `user_uuid` is missing."))
      }
      ...
      if (!is.null(input_json$`created_at`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SimplifiedObservation: the required field `created_at` is missing."))
      }
      ...
      if (!is.null(input_json$`created_at_local`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SimplifiedObservation: the required field `created_at_local` is missing."))
      }
      ...
      if (!is.null(input_json$`received_at`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SimplifiedObservation: the required field `received_at` is missing."))
      }
      # check the required field `location`
      if (!is.null(input_json$`location`)) {
        stopifnot(R6::is.R6(input_json$`location`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for SimplifiedObservation: the required field `location` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of SimplifiedObservation
    toString = function() {
      self$toJSONString()
    },
...
# SimplifiedObservation$unlock()
#
## Below is an example to define the print function
# SimplifiedObservation$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SimplifiedObservation$lock()
