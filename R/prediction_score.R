...
#' @description PredictionScore Class
...
PredictionScore <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PredictionScore class.
    #'
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`ae_aegypti`)) {
        PredictionScoreObject[["ae_aegypti"]] <-
          self$`ae_aegypti`
      }
      if (!is.null(self$`ae_japonicus`)) {
        PredictionScoreObject[["ae_japonicus"]] <-
          self$`ae_japonicus`
      }
      if (!is.null(self$`ae_koreicus`)) {
        PredictionScoreObject[["ae_koreicus"]] <-
          self$`ae_koreicus`
      }
      if (!is.null(self$`culex`)) {
        PredictionScoreObject[["culex"]] <-
          self$`culex`
      }
      if (!is.null(self$`anopheles`)) {
        PredictionScoreObject[["anopheles"]] <-
          self$`anopheles`
      }
      if (!is.null(self$`culiseta`)) {
        PredictionScoreObject[["culiseta"]] <-
          self$`culiseta`
      }
      if (!is.null(self$`other_species`)) {
        PredictionScoreObject[["other_species"]] <-
          self$`other_species`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of PredictionScore
    #'
    #' @param input_json the JSON input
    #' @return the instance of PredictionScore
    ...
    #' @description
    #' Validate JSON input with respect to PredictionScore and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`ae_albopictus`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionScore: the required field `ae_albopictus` is missing."))
      }
      ...
      if (!is.null(input_json$`ae_aegypti`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionScore: the required field `ae_aegypti` is missing."))
      }
      ...
      if (!is.null(input_json$`ae_japonicus`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionScore: the required field `ae_japonicus` is missing."))
      }
      ...
      if (!is.null(input_json$`ae_koreicus`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionScore: the required field `ae_koreicus` is missing."))
      }
      ...
      if (!is.null(input_json$`culex`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionScore: the required field `culex` is missing."))
      }
      ...
      if (!is.null(input_json$`anopheles`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionScore: the required field `anopheles` is missing."))
      }
      ...
      if (!is.null(input_json$`culiseta`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionScore: the required field `culiseta` is missing."))
      }
      ...
      if (!is.null(input_json$`other_species`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionScore: the required field `other_species` is missing."))
      }
      ...
      if (!is.null(input_json$`not_sure`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PredictionScore: the required field `not_sure` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PredictionScore
    toString = function() {
      self$toJSONString()
    },
...
# PredictionScore$unlock()
#
## Below is an example to define the print function
# PredictionScore$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PredictionScore$lock()
