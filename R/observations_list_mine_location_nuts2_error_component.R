#' Create a new ObservationsListMineLocationNuts2ErrorComponent
#'
#' @description
#' ObservationsListMineLocationNuts2ErrorComponent Class
#'
#' @docType class
#' @title ObservationsListMineLocationNuts2ErrorComponent
#' @description ObservationsListMineLocationNuts2ErrorComponent Class
...
#' @export
ObservationsListMineLocationNuts2ErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsListMineLocationNuts2ErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsListMineLocationNuts2ErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsListMineLocationNuts2ErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsListMineLocationNuts2ErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsListMineLocationNuts2ErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsListMineLocationNuts2ErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsListMineLocationNuts2ErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsListMineLocationNuts2ErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsListMineLocationNuts2ErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsListMineLocationNuts2ErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsListMineLocationNuts2ErrorComponent
    ...
    #' @return ObservationsListMineLocationNuts2ErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsListMineLocationNuts2ErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineLocationNuts2ErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineLocationNuts2ErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineLocationNuts2ErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsListMineLocationNuts2ErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsListMineLocationNuts2ErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsListMineLocationNuts2ErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsListMineLocationNuts2ErrorComponent$lock()
