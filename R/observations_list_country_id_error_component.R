#' Create a new ObservationsListCountryIdErrorComponent
#'
#' @description
#' ObservationsListCountryIdErrorComponent Class
#'
#' @docType class
#' @title ObservationsListCountryIdErrorComponent
#' @description ObservationsListCountryIdErrorComponent Class
...
#' @export
ObservationsListCountryIdErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsListCountryIdErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsListCountryIdErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsListCountryIdErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsListCountryIdErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsListCountryIdErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsListCountryIdErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsListCountryIdErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsListCountryIdErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsListCountryIdErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsListCountryIdErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsListCountryIdErrorComponent
    ...
    #' @return ObservationsListCountryIdErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsListCountryIdErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListCountryIdErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListCountryIdErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListCountryIdErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsListCountryIdErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsListCountryIdErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsListCountryIdErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsListCountryIdErrorComponent$lock()
