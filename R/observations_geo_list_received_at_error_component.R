#' Create a new ObservationsGeoListReceivedAtErrorComponent
#'
#' @description
#' ObservationsGeoListReceivedAtErrorComponent Class
#'
#' @docType class
#' @title ObservationsGeoListReceivedAtErrorComponent
#' @description ObservationsGeoListReceivedAtErrorComponent Class
...
#' @export
ObservationsGeoListReceivedAtErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsGeoListReceivedAtErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsGeoListReceivedAtErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsGeoListReceivedAtErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsGeoListReceivedAtErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsGeoListReceivedAtErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsGeoListReceivedAtErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsGeoListReceivedAtErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsGeoListReceivedAtErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsGeoListReceivedAtErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsGeoListReceivedAtErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsGeoListReceivedAtErrorComponent
    ...
    #' @return ObservationsGeoListReceivedAtErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsGeoListReceivedAtErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsGeoListReceivedAtErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsGeoListReceivedAtErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsGeoListReceivedAtErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsGeoListReceivedAtErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsGeoListReceivedAtErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsGeoListReceivedAtErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsGeoListReceivedAtErrorComponent$lock()
