#' Create a new ObservationsGeoListBoundaryUuidErrorComponent
#'
#' @description
#' ObservationsGeoListBoundaryUuidErrorComponent Class
#'
#' @docType class
#' @title ObservationsGeoListBoundaryUuidErrorComponent
#' @description ObservationsGeoListBoundaryUuidErrorComponent Class
...
#' @export
ObservationsGeoListBoundaryUuidErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsGeoListBoundaryUuidErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsGeoListBoundaryUuidErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsGeoListBoundaryUuidErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsGeoListBoundaryUuidErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsGeoListBoundaryUuidErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsGeoListBoundaryUuidErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsGeoListBoundaryUuidErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsGeoListBoundaryUuidErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsGeoListBoundaryUuidErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsGeoListBoundaryUuidErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsGeoListBoundaryUuidErrorComponent
    ...
    #' @return ObservationsGeoListBoundaryUuidErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsGeoListBoundaryUuidErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsGeoListBoundaryUuidErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsGeoListBoundaryUuidErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsGeoListBoundaryUuidErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsGeoListBoundaryUuidErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsGeoListBoundaryUuidErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsGeoListBoundaryUuidErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsGeoListBoundaryUuidErrorComponent$lock()
