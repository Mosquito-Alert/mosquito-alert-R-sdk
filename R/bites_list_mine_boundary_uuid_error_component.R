#' Create a new BitesListMineBoundaryUuidErrorComponent
#'
#' @description
#' BitesListMineBoundaryUuidErrorComponent Class
#'
#' @docType class
#' @title BitesListMineBoundaryUuidErrorComponent
#' @description BitesListMineBoundaryUuidErrorComponent Class
...
#' @export
BitesListMineBoundaryUuidErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesListMineBoundaryUuidErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesListMineBoundaryUuidErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesListMineBoundaryUuidErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesListMineBoundaryUuidErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesListMineBoundaryUuidErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesListMineBoundaryUuidErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesListMineBoundaryUuidErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesListMineBoundaryUuidErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesListMineBoundaryUuidErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesListMineBoundaryUuidErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesListMineBoundaryUuidErrorComponent
    ...
    #' @return BitesListMineBoundaryUuidErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesListMineBoundaryUuidErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineBoundaryUuidErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineBoundaryUuidErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineBoundaryUuidErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesListMineBoundaryUuidErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesListMineBoundaryUuidErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesListMineBoundaryUuidErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesListMineBoundaryUuidErrorComponent$lock()
