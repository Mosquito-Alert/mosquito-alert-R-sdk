...
BreedingsitesListValidationError <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BreedingsitesListValidationError as a base R list.
    #' @examples
    #' # convert array of BreedingsitesListValidationError (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BreedingsitesListValidationError to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(BreedingsitesListValidationErrorObject)
    },
