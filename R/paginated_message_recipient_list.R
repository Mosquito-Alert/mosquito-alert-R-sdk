#' Create a new PaginatedMessageRecipientList
#'
#' @description
#' PaginatedMessageRecipientList Class
#'
#' @docType class
#' @title PaginatedMessageRecipientList
#' @description PaginatedMessageRecipientList Class
#' @format An \code{R6Class} generator object
#' @field count  integer
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{MessageRecipient})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedMessageRecipientList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedMessageRecipientList class.
    #'
    #' @param count count
    ...
    #'
    #' @return PaginatedMessageRecipientList as a base R list.
    #' @examples
    #' # convert array of PaginatedMessageRecipientList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedMessageRecipientList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedMessageRecipientListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedMessageRecipientListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedMessageRecipientListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedMessageRecipientListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedMessageRecipientListObject[["results"]] <-
          self$extractSimpleType(self$`results`)
      }
      return(PaginatedMessageRecipientListObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of PaginatedMessageRecipientList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedMessageRecipientList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[MessageRecipient]", loadNamespace("MosquitoAlert"))
      }
      self
    },
    ...
    #' @return PaginatedMessageRecipientList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedMessageRecipientList and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PaginatedMessageRecipientList: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`results`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PaginatedMessageRecipientList: the required field `results` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PaginatedMessageRecipientList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedMessageRecipientList$unlock()
#
## Below is an example to define the print function
# PaginatedMessageRecipientList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedMessageRecipientList$lock()
