#' Create a new LocalizedMessageBodyPreview
#'
#' @description
...
#'
#' @docType class
#' @title LocalizedMessageBodyPreview
#' @description LocalizedMessageBodyPreview Class
...
#' @export
LocalizedMessageBodyPreview <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LocalizedMessageBodyPreview class.
    #'
    #' @param bg Български
    #' @param bn বাংলা
    #' @param ca Català
    ...
    #'
    #' @return LocalizedMessageBodyPreview as a base R list.
    #' @examples
    #' # convert array of LocalizedMessageBodyPreview (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LocalizedMessageBodyPreview to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LocalizedMessageBodyPreviewObject <- list()
      if (!is.null(self$`bg`)) {
        LocalizedMessageBodyPreviewObject[["bg"]] <-
          self$`bg`
      }
      if (!is.null(self$`bn`)) {
        LocalizedMessageBodyPreviewObject[["bn"]] <-
          self$`bn`
      }
      if (!is.null(self$`ca`)) {
        LocalizedMessageBodyPreviewObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`de`)) {
        LocalizedMessageBodyPreviewObject[["de"]] <-
          self$`de`
      }
      if (!is.null(self$`el`)) {
        LocalizedMessageBodyPreviewObject[["el"]] <-
          self$`el`
      }
      if (!is.null(self$`en`)) {
        LocalizedMessageBodyPreviewObject[["en"]] <-
          self$`en`
      }
      if (!is.null(self$`es`)) {
        LocalizedMessageBodyPreviewObject[["es"]] <-
          self$`es`
      }
      if (!is.null(self$`eu`)) {
        LocalizedMessageBodyPreviewObject[["eu"]] <-
          self$`eu`
      }
      if (!is.null(self$`fr`)) {
        LocalizedMessageBodyPreviewObject[["fr"]] <-
          self$`fr`
      }
      if (!is.null(self$`gl`)) {
        LocalizedMessageBodyPreviewObject[["gl"]] <-
          self$`gl`
      }
      if (!is.null(self$`hr`)) {
        LocalizedMessageBodyPreviewObject[["hr"]] <-
          self$`hr`
      }
      if (!is.null(self$`hu`)) {
        LocalizedMessageBodyPreviewObject[["hu"]] <-
          self$`hu`
      }
      if (!is.null(self$`it`)) {
        LocalizedMessageBodyPreviewObject[["it"]] <-
          self$`it`
      }
      if (!is.null(self$`lb`)) {
        LocalizedMessageBodyPreviewObject[["lb"]] <-
          self$`lb`
      }
      if (!is.null(self$`mk`)) {
        LocalizedMessageBodyPreviewObject[["mk"]] <-
          self$`mk`
      }
      if (!is.null(self$`nl`)) {
        LocalizedMessageBodyPreviewObject[["nl"]] <-
          self$`nl`
      }
      if (!is.null(self$`pt`)) {
        LocalizedMessageBodyPreviewObject[["pt"]] <-
          self$`pt`
      }
      if (!is.null(self$`ro`)) {
        LocalizedMessageBodyPreviewObject[["ro"]] <-
          self$`ro`
      }
      if (!is.null(self$`sl`)) {
        LocalizedMessageBodyPreviewObject[["sl"]] <-
          self$`sl`
      }
      if (!is.null(self$`sq`)) {
        LocalizedMessageBodyPreviewObject[["sq"]] <-
          self$`sq`
      }
      if (!is.null(self$`sr`)) {
        LocalizedMessageBodyPreviewObject[["sr"]] <-
          self$`sr`
      }
      if (!is.null(self$`sv`)) {
        LocalizedMessageBodyPreviewObject[["sv"]] <-
          self$`sv`
      }
      if (!is.null(self$`tr`)) {
        LocalizedMessageBodyPreviewObject[["tr"]] <-
          self$`tr`
      }
      if (!is.null(self$`zh-cn`)) {
        LocalizedMessageBodyPreviewObject[["zh-cn"]] <-
          self$`zh-cn`
      }
      return(LocalizedMessageBodyPreviewObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LocalizedMessageBodyPreview
    #'
    #' @param input_json the JSON input
    #' @return the instance of LocalizedMessageBodyPreview
    ...
    #' @return LocalizedMessageBodyPreview in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LocalizedMessageBodyPreview and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of LocalizedMessageBodyPreview
    toString = function() {
      self$toJSONString()
    },
...
# LocalizedMessageBodyPreview$unlock()
#
## Below is an example to define the print function
# LocalizedMessageBodyPreview$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LocalizedMessageBodyPreview$lock()
