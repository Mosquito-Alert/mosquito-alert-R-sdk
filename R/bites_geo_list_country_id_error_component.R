#' Create a new BitesGeoListCountryIdErrorComponent
#'
#' @description
#' BitesGeoListCountryIdErrorComponent Class
#'
#' @docType class
#' @title BitesGeoListCountryIdErrorComponent
#' @description BitesGeoListCountryIdErrorComponent Class
...
#' @export
BitesGeoListCountryIdErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesGeoListCountryIdErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesGeoListCountryIdErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesGeoListCountryIdErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesGeoListCountryIdErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesGeoListCountryIdErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesGeoListCountryIdErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesGeoListCountryIdErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesGeoListCountryIdErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesGeoListCountryIdErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesGeoListCountryIdErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesGeoListCountryIdErrorComponent
    ...
    #' @return BitesGeoListCountryIdErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesGeoListCountryIdErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesGeoListCountryIdErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesGeoListCountryIdErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesGeoListCountryIdErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesGeoListCountryIdErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesGeoListCountryIdErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesGeoListCountryIdErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesGeoListCountryIdErrorComponent$lock()
