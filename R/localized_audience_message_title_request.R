#' Create a new LocalizedAudienceMessageTitleRequest
#'
#' @description
...
#'
#' @docType class
#' @title LocalizedAudienceMessageTitleRequest
#' @description LocalizedAudienceMessageTitleRequest Class
...
#' @export
LocalizedAudienceMessageTitleRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LocalizedAudienceMessageTitleRequest class.
    #'
    #' @param en English
    #' @param bg Български
    #' @param bn বাংলা
    ...
    #'
    #' @return LocalizedAudienceMessageTitleRequest as a base R list.
    #' @examples
    #' # convert array of LocalizedAudienceMessageTitleRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LocalizedAudienceMessageTitleRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LocalizedAudienceMessageTitleRequestObject <- list()
      if (!is.null(self$`bg`)) {
        LocalizedAudienceMessageTitleRequestObject[["bg"]] <-
          self$`bg`
      }
      if (!is.null(self$`bn`)) {
        LocalizedAudienceMessageTitleRequestObject[["bn"]] <-
          self$`bn`
      }
      if (!is.null(self$`ca`)) {
        LocalizedAudienceMessageTitleRequestObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`de`)) {
        LocalizedAudienceMessageTitleRequestObject[["de"]] <-
          self$`de`
      }
      if (!is.null(self$`el`)) {
        LocalizedAudienceMessageTitleRequestObject[["el"]] <-
          self$`el`
      }
      if (!is.null(self$`en`)) {
        LocalizedAudienceMessageTitleRequestObject[["en"]] <-
          self$`en`
      }
      if (!is.null(self$`es`)) {
        LocalizedAudienceMessageTitleRequestObject[["es"]] <-
          self$`es`
      }
      if (!is.null(self$`eu`)) {
        LocalizedAudienceMessageTitleRequestObject[["eu"]] <-
          self$`eu`
      }
      if (!is.null(self$`fr`)) {
        LocalizedAudienceMessageTitleRequestObject[["fr"]] <-
          self$`fr`
      }
      if (!is.null(self$`gl`)) {
        LocalizedAudienceMessageTitleRequestObject[["gl"]] <-
          self$`gl`
      }
      if (!is.null(self$`hr`)) {
        LocalizedAudienceMessageTitleRequestObject[["hr"]] <-
          self$`hr`
      }
      if (!is.null(self$`hu`)) {
        LocalizedAudienceMessageTitleRequestObject[["hu"]] <-
          self$`hu`
      }
      if (!is.null(self$`it`)) {
        LocalizedAudienceMessageTitleRequestObject[["it"]] <-
          self$`it`
      }
      if (!is.null(self$`lb`)) {
        LocalizedAudienceMessageTitleRequestObject[["lb"]] <-
          self$`lb`
      }
      if (!is.null(self$`mk`)) {
        LocalizedAudienceMessageTitleRequestObject[["mk"]] <-
          self$`mk`
      }
      if (!is.null(self$`nl`)) {
        LocalizedAudienceMessageTitleRequestObject[["nl"]] <-
          self$`nl`
      }
      if (!is.null(self$`pt`)) {
        LocalizedAudienceMessageTitleRequestObject[["pt"]] <-
          self$`pt`
      }
      if (!is.null(self$`ro`)) {
        LocalizedAudienceMessageTitleRequestObject[["ro"]] <-
          self$`ro`
      }
      if (!is.null(self$`sl`)) {
        LocalizedAudienceMessageTitleRequestObject[["sl"]] <-
          self$`sl`
      }
      if (!is.null(self$`sq`)) {
        LocalizedAudienceMessageTitleRequestObject[["sq"]] <-
          self$`sq`
      }
      if (!is.null(self$`sr`)) {
        LocalizedAudienceMessageTitleRequestObject[["sr"]] <-
          self$`sr`
      }
      if (!is.null(self$`sv`)) {
        LocalizedAudienceMessageTitleRequestObject[["sv"]] <-
          self$`sv`
      }
      if (!is.null(self$`tr`)) {
        LocalizedAudienceMessageTitleRequestObject[["tr"]] <-
          self$`tr`
      }
      if (!is.null(self$`zh-cn`)) {
        LocalizedAudienceMessageTitleRequestObject[["zh-cn"]] <-
          self$`zh-cn`
      }
      return(LocalizedAudienceMessageTitleRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LocalizedAudienceMessageTitleRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of LocalizedAudienceMessageTitleRequest
    ...
    #' @return LocalizedAudienceMessageTitleRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LocalizedAudienceMessageTitleRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`en`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalizedAudienceMessageTitleRequest: the required field `en` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LocalizedAudienceMessageTitleRequest
    toString = function() {
      self$toJSONString()
    },
...
# LocalizedAudienceMessageTitleRequest$unlock()
#
## Below is an example to define the print function
# LocalizedAudienceMessageTitleRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LocalizedAudienceMessageTitleRequest$lock()
