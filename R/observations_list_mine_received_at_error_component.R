#' Create a new ObservationsListMineReceivedAtErrorComponent
#'
#' @description
#' ObservationsListMineReceivedAtErrorComponent Class
#'
#' @docType class
#' @title ObservationsListMineReceivedAtErrorComponent
#' @description ObservationsListMineReceivedAtErrorComponent Class
...
#' @export
ObservationsListMineReceivedAtErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsListMineReceivedAtErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsListMineReceivedAtErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsListMineReceivedAtErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsListMineReceivedAtErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsListMineReceivedAtErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsListMineReceivedAtErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsListMineReceivedAtErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsListMineReceivedAtErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsListMineReceivedAtErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsListMineReceivedAtErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsListMineReceivedAtErrorComponent
    ...
    #' @return ObservationsListMineReceivedAtErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsListMineReceivedAtErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineReceivedAtErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineReceivedAtErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineReceivedAtErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsListMineReceivedAtErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsListMineReceivedAtErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsListMineReceivedAtErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsListMineReceivedAtErrorComponent$lock()
