#' Create a new AuthRefreshTokenNonFieldErrorsErrorComponent
#'
#' @description
#' AuthRefreshTokenNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title AuthRefreshTokenNonFieldErrorsErrorComponent
#' @description AuthRefreshTokenNonFieldErrorsErrorComponent Class
...
#' @export
AuthRefreshTokenNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AuthRefreshTokenNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return AuthRefreshTokenNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of AuthRefreshTokenNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AuthRefreshTokenNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AuthRefreshTokenNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        AuthRefreshTokenNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        AuthRefreshTokenNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        AuthRefreshTokenNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(AuthRefreshTokenNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of AuthRefreshTokenNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of AuthRefreshTokenNonFieldErrorsErrorComponent
    ...
    #' @return AuthRefreshTokenNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AuthRefreshTokenNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthRefreshTokenNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthRefreshTokenNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthRefreshTokenNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AuthRefreshTokenNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# AuthRefreshTokenNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# AuthRefreshTokenNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AuthRefreshTokenNonFieldErrorsErrorComponent$lock()
