#' Create a new ObservationsGeoListCountryIdErrorComponent
#'
#' @description
#' ObservationsGeoListCountryIdErrorComponent Class
#'
#' @docType class
#' @title ObservationsGeoListCountryIdErrorComponent
#' @description ObservationsGeoListCountryIdErrorComponent Class
...
#' @export
ObservationsGeoListCountryIdErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsGeoListCountryIdErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsGeoListCountryIdErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsGeoListCountryIdErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsGeoListCountryIdErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsGeoListCountryIdErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsGeoListCountryIdErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsGeoListCountryIdErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsGeoListCountryIdErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsGeoListCountryIdErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsGeoListCountryIdErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsGeoListCountryIdErrorComponent
    ...
    #' @return ObservationsGeoListCountryIdErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsGeoListCountryIdErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsGeoListCountryIdErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsGeoListCountryIdErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsGeoListCountryIdErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsGeoListCountryIdErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsGeoListCountryIdErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsGeoListCountryIdErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsGeoListCountryIdErrorComponent$lock()
