...
#' @docType class
#' @title PartnerPoint
#' @description PartnerPoint Class
...
PartnerPoint <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PartnerPoint class.
    #'
    ...
    #'
    #' @return PartnerPoint as a base R list.
    #' @examples
    #' # convert array of PartnerPoint (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PartnerPoint to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PartnerPointObject <- list()
      if (!is.null(self$`latitude`)) {
        PartnerPointObject[["latitude"]] <-
          self$`latitude`
      }
      if (!is.null(self$`longitude`)) {
        PartnerPointObject[["longitude"]] <-
          self$`longitude`
      }
      return(PartnerPointObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PartnerPoint
    #'
    #' @param input_json the JSON input
    #' @return the instance of PartnerPoint
    ...
    #' @return PartnerPoint in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PartnerPoint and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`latitude`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PartnerPoint: the required field `latitude` is missing."))
      }
      ...
      if (!is.null(input_json$`longitude`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PartnerPoint: the required field `longitude` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PartnerPoint
    toString = function() {
      self$toJSONString()
    },
...
# PartnerPoint$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
