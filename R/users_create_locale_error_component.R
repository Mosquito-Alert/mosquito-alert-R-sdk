#' Create a new UsersCreateLocaleErrorComponent
#'
#' @description
#' UsersCreateLocaleErrorComponent Class
#'
#' @docType class
#' @title UsersCreateLocaleErrorComponent
#' @description UsersCreateLocaleErrorComponent Class
...
#' @export
UsersCreateLocaleErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new UsersCreateLocaleErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #' To JSON String
    #'
    #' @return UsersCreateLocaleErrorComponent in JSON format
    toJSON = function() {
      UsersCreateLocaleErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        UsersCreateLocaleErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        UsersCreateLocaleErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        UsersCreateLocaleErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      UsersCreateLocaleErrorComponentObject
    },

    #' @description
    #' Deserialize JSON string into an instance of UsersCreateLocaleErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of UsersCreateLocaleErrorComponent
    ...
    #' @description
    #' Validate JSON input with respect to UsersCreateLocaleErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersCreateLocaleErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersCreateLocaleErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersCreateLocaleErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of UsersCreateLocaleErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# UsersCreateLocaleErrorComponent$unlock()
#
## Below is an example to define the print function
# UsersCreateLocaleErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UsersCreateLocaleErrorComponent$lock()
