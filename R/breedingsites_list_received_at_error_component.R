...
BreedingsitesListReceivedAtErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return BreedingsitesListReceivedAtErrorComponent as a base R list.
    #' @examples
    #' # convert array of BreedingsitesListReceivedAtErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BreedingsitesListReceivedAtErrorComponent to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(BreedingsitesListReceivedAtErrorComponentObject)
    },
