#' Create a new CreatePhotoPrediction
#'
#' @description
#' CreatePhotoPrediction Class
#'
#' @docType class
#' @title CreatePhotoPrediction
#' @description CreatePhotoPrediction Class
...
#' @export
CreatePhotoPrediction <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CreatePhotoPrediction class.
    #'
    #' @param photo photo
    #' @param bbox bbox
    ...
    #'
    #' @return CreatePhotoPrediction as a base R list.
    #' @examples
    #' # convert array of CreatePhotoPrediction (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreatePhotoPrediction to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CreatePhotoPredictionObject <- list()
      if (!is.null(self$`photo`)) {
        CreatePhotoPredictionObject[["photo"]] <-
          self$`photo`$toSimpleType()
      }
      if (!is.null(self$`bbox`)) {
        CreatePhotoPredictionObject[["bbox"]] <-
          self$`bbox`$toSimpleType()
      }
      if (!is.null(self$`insect_confidence`)) {
        CreatePhotoPredictionObject[["insect_confidence"]] <-
      ...
      if (!is.null(self$`is_decisive`)) {
        CreatePhotoPredictionObject[["is_decisive"]] <-
          self$`is_decisive`
      }
      if (!is.null(self$`scores`)) {
        CreatePhotoPredictionObject[["scores"]] <-
          self$`scores`$toSimpleType()
      }
      if (!is.null(self$`classifier_version`)) {
        CreatePhotoPredictionObject[["classifier_version"]] <-
          self$`classifier_version`
      }
      if (!is.null(self$`created_at`)) {
        CreatePhotoPredictionObject[["created_at"]] <-
          self$`created_at`
      }
      if (!is.null(self$`updated_at`)) {
        CreatePhotoPredictionObject[["updated_at"]] <-
          self$`updated_at`
      }
      return(CreatePhotoPredictionObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of CreatePhotoPrediction
    #'
    #' @param input_json the JSON input
    #' @return the instance of CreatePhotoPrediction
    ...
    #' @return CreatePhotoPrediction in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CreatePhotoPrediction and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`photo`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPrediction: the required field `photo` is missing."))
      }
      # check the required field `bbox`
      if (!is.null(input_json$`bbox`)) {
        stopifnot(R6::is.R6(input_json$`bbox`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPrediction: the required field `bbox` is missing."))
      }
      ...
      if (!is.null(input_json$`insect_confidence`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPrediction: the required field `insect_confidence` is missing."))
      }
      ...
      if (!is.null(input_json$`threshold_deviation`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPrediction: the required field `threshold_deviation` is missing."))
      }
      # check the required field `scores`
      if (!is.null(input_json$`scores`)) {
        stopifnot(R6::is.R6(input_json$`scores`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPrediction: the required field `scores` is missing."))
      }
      ...
      if (!is.null(input_json$`classifier_version`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPrediction: the required field `classifier_version` is missing."))
      }
      ...
      if (!is.null(input_json$`created_at`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPrediction: the required field `created_at` is missing."))
      }
      ...
      if (!is.null(input_json$`updated_at`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPrediction: the required field `updated_at` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CreatePhotoPrediction
    toString = function() {
      self$toJSONString()
    },
...
# CreatePhotoPrediction$unlock()
#
## Below is an example to define the print function
# CreatePhotoPrediction$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CreatePhotoPrediction$lock()
