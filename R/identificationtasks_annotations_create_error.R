...
IdentificationtasksAnnotationsCreateError <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(instance = NULL) {
      ...
      } else if (get(class(instance)[[1]], pos = -1)$classname ==  "IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent") {
        self$actual_instance <- instance
        self$actual_type <- "IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent"
    ...
    fromJSON = function(input) {
      ...
      `IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent_result` <- tryCatch({
          `IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent`$public_methods$validateJSON(input)
          `IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent_instance` <- `IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent`$new()
          instance <- `IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent_instance`$fromJSON(input)
          instance_type <- "IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent"
          matched_schemas <- append(matched_schemas, "IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent")
          matched <- matched + 1
        },
        error = function(err) err
      )

      if (!is.null(`IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent_result`["error"])) {
        error_messages <- append(error_messages, `IdentificationtasksAnnotationsCreateIsExecutiveErrorComponent_result`["message"])
      }
