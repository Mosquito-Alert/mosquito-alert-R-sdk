#' Create a new ObservationsListLocationNuts2ErrorComponent
#'
#' @description
#' ObservationsListLocationNuts2ErrorComponent Class
#'
#' @docType class
#' @title ObservationsListLocationNuts2ErrorComponent
#' @description ObservationsListLocationNuts2ErrorComponent Class
...
#' @export
ObservationsListLocationNuts2ErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsListLocationNuts2ErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsListLocationNuts2ErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsListLocationNuts2ErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsListLocationNuts2ErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsListLocationNuts2ErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsListLocationNuts2ErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsListLocationNuts2ErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsListLocationNuts2ErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsListLocationNuts2ErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsListLocationNuts2ErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsListLocationNuts2ErrorComponent
    ...
    #' @return ObservationsListLocationNuts2ErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsListLocationNuts2ErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListLocationNuts2ErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListLocationNuts2ErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListLocationNuts2ErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsListLocationNuts2ErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsListLocationNuts2ErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsListLocationNuts2ErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsListLocationNuts2ErrorComponent$lock()
