#' Create a new BreedingsitesGeoListBoundaryUuidErrorComponent
#'
#' @description
#' BreedingsitesGeoListBoundaryUuidErrorComponent Class
#'
#' @docType class
#' @title BreedingsitesGeoListBoundaryUuidErrorComponent
#' @description BreedingsitesGeoListBoundaryUuidErrorComponent Class
...
#' @export
BreedingsitesGeoListBoundaryUuidErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BreedingsitesGeoListBoundaryUuidErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BreedingsitesGeoListBoundaryUuidErrorComponent as a base R list.
    #' @examples
    #' # convert array of BreedingsitesGeoListBoundaryUuidErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BreedingsitesGeoListBoundaryUuidErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BreedingsitesGeoListBoundaryUuidErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BreedingsitesGeoListBoundaryUuidErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BreedingsitesGeoListBoundaryUuidErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BreedingsitesGeoListBoundaryUuidErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BreedingsitesGeoListBoundaryUuidErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BreedingsitesGeoListBoundaryUuidErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BreedingsitesGeoListBoundaryUuidErrorComponent
    ...
    #' @return BreedingsitesGeoListBoundaryUuidErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BreedingsitesGeoListBoundaryUuidErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesGeoListBoundaryUuidErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesGeoListBoundaryUuidErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesGeoListBoundaryUuidErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BreedingsitesGeoListBoundaryUuidErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BreedingsitesGeoListBoundaryUuidErrorComponent$unlock()
#
## Below is an example to define the print function
# BreedingsitesGeoListBoundaryUuidErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BreedingsitesGeoListBoundaryUuidErrorComponent$lock()
