...
UsersApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param audience_filter_request (optional) No description
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return PaginatedUserList
    audience_filter = function(page = NULL, page_size = NULL, audience_filter_request = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$audience_filter_with_http_info(page, page_size, audience_filter_request, data_file = data_file, ..., .parse = .parse)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (PaginatedUserList) with additional information such as HTTP status code, headers
    audience_filter_with_http_info = function(page = NULL, page_size = NULL, audience_filter_request = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!missing(`page`) && is.null(`page`)) {
        stop("Invalid value for `page` when calling UsersApi$audience_filter, `page` is not nullable")
      }

      if (!missing(`page_size`) && is.null(`page_size`)) {
        stop("Invalid value for `page_size` when calling UsersApi$audience_filter, `page_size` is not nullable")
      }

      if (!missing(`audience_filter_request`) && is.null(`audience_filter_request`)) {
        stop("Invalid value for `audience_filter_request` when calling UsersApi$audience_filter, `audience_filter_request` is not nullable")
      }
      ...
      if (!is.null(`audience_filter_request`)) {
        local_var_body <- `audience_filter_request`$toJSONString()
      } else {
        local_var_body <- NULL
      }

      local_var_url_path <- "/users/audience/"
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "PaginatedUserList"),
          error = function(e) {
    ...
    #'
    #' @return PaginatedUserList
    list = function(page = NULL, page_size = NULL, search = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$list_with_http_info(page, page_size, search, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (PaginatedUserList) with additional information such as HTTP status code, headers
    list_with_http_info = function(page = NULL, page_size = NULL, search = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!missing(`page`) && is.null(`page`)) {
        stop("Invalid value for `page` when calling UsersApi$list, `page` is not nullable")
      }

      if (!missing(`page_size`) && is.null(`page_size`)) {
        stop("Invalid value for `page_size` when calling UsersApi$list, `page_size` is not nullable")
      }

      if (!missing(`search`) && is.null(`search`)) {
        stop("Invalid value for `search` when calling UsersApi$list, `search` is not nullable")
      }
    ...
    #'
    #' @return User
    partial_update = function(uuid, patched_user_request = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$partial_update_with_http_info(uuid, patched_user_request, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    partial_update_with_http_info = function(uuid, patched_user_request = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return User
    update = function(uuid, user_request = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$update_with_http_info(uuid, user_request, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (User) with additional information such as HTTP status code, headers
    update_with_http_info = function(uuid, user_request = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
