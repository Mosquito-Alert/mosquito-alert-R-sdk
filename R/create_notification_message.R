#' Create a new CreateNotificationMessage
#'
#' @description
#' CreateNotificationMessage Class
#'
#' @docType class
...
#' @export
CreateNotificationMessage <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CreateNotificationMessage class.
    #'
    ...
    #'
    #' @return CreateNotificationMessage as a base R list.
    #' @examples
    #' # convert array of CreateNotificationMessage (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateNotificationMessage to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of CreateNotificationMessage
    #'
    ...
    #' @return CreateNotificationMessage in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CreateNotificationMessage and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`title`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateNotificationMessage: the required field `title` is missing."))
      }
      # check the required field `body`
      if (!is.null(input_json$`body`)) {
        stopifnot(R6::is.R6(input_json$`body`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for CreateNotificationMessage: the required field `body` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CreateNotificationMessage
    toString = function() {
      self$toJSONString()
    },
...
# CreateNotificationMessage$unlock()
#
## Below is an example to define the print function
# CreateNotificationMessage$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CreateNotificationMessage$lock()
