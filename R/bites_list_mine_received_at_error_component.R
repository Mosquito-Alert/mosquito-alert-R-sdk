#' Create a new BitesListMineReceivedAtErrorComponent
#'
#' @description
#' BitesListMineReceivedAtErrorComponent Class
#'
#' @docType class
#' @title BitesListMineReceivedAtErrorComponent
#' @description BitesListMineReceivedAtErrorComponent Class
...
#' @export
BitesListMineReceivedAtErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesListMineReceivedAtErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesListMineReceivedAtErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesListMineReceivedAtErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesListMineReceivedAtErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesListMineReceivedAtErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesListMineReceivedAtErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesListMineReceivedAtErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesListMineReceivedAtErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesListMineReceivedAtErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesListMineReceivedAtErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesListMineReceivedAtErrorComponent
    ...
    #' @return BitesListMineReceivedAtErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesListMineReceivedAtErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineReceivedAtErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineReceivedAtErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesListMineReceivedAtErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesListMineReceivedAtErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesListMineReceivedAtErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesListMineReceivedAtErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesListMineReceivedAtErrorComponent$lock()
