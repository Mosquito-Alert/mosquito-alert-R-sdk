...
Taxon <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`id`, `name`, `rank`, `italicize`, `is_relevant`, `common_name` = NULL, ...) {
      if (!missing(`id`)) {
    ...
    #'
    #' @return Taxon as a base R list.
    #' @examples
    #' # convert array of Taxon (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert Taxon to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`italicize`)) {
        TaxonObject[["italicize"]] <-
          self$`italicize`
      }
      if (!is.null(self$`is_relevant`)) {
        TaxonObject[["is_relevant"]] <-
          self$`is_relevant`
      }
      return(TaxonObject)
    },
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Taxon: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Taxon: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`rank`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Taxon: the required field `rank` is missing."))
      }
      ...
      if (!is.null(input_json$`italicize`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Taxon: the required field `italicize` is missing."))
      }
      ...
      if (!is.null(input_json$`is_relevant`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Taxon: the required field `is_relevant` is missing."))
      }
    },
