#' Create a new BitesCreateNonFieldErrorsErrorComponent
#'
#' @description
#' BitesCreateNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title BitesCreateNonFieldErrorsErrorComponent
#' @description BitesCreateNonFieldErrorsErrorComponent Class
...
#' @export
BitesCreateNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesCreateNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesCreateNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesCreateNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesCreateNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesCreateNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesCreateNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesCreateNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesCreateNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesCreateNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesCreateNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesCreateNonFieldErrorsErrorComponent
    ...
    #' @return BitesCreateNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesCreateNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesCreateNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesCreateNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesCreateNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesCreateNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesCreateNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesCreateNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesCreateNonFieldErrorsErrorComponent$lock()
