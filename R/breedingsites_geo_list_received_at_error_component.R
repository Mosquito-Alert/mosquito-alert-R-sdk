#' Create a new BreedingsitesGeoListReceivedAtErrorComponent
#'
#' @description
#' BreedingsitesGeoListReceivedAtErrorComponent Class
#'
#' @docType class
#' @title BreedingsitesGeoListReceivedAtErrorComponent
#' @description BreedingsitesGeoListReceivedAtErrorComponent Class
...
#' @export
BreedingsitesGeoListReceivedAtErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BreedingsitesGeoListReceivedAtErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BreedingsitesGeoListReceivedAtErrorComponent as a base R list.
    #' @examples
    #' # convert array of BreedingsitesGeoListReceivedAtErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BreedingsitesGeoListReceivedAtErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BreedingsitesGeoListReceivedAtErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BreedingsitesGeoListReceivedAtErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BreedingsitesGeoListReceivedAtErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BreedingsitesGeoListReceivedAtErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BreedingsitesGeoListReceivedAtErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BreedingsitesGeoListReceivedAtErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BreedingsitesGeoListReceivedAtErrorComponent
    ...
    #' @return BreedingsitesGeoListReceivedAtErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BreedingsitesGeoListReceivedAtErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesGeoListReceivedAtErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesGeoListReceivedAtErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesGeoListReceivedAtErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BreedingsitesGeoListReceivedAtErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BreedingsitesGeoListReceivedAtErrorComponent$unlock()
#
## Below is an example to define the print function
# BreedingsitesGeoListReceivedAtErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BreedingsitesGeoListReceivedAtErrorComponent$lock()
