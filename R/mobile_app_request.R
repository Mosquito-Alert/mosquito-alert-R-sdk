...
MobileAppRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MobileAppRequest as a base R list.
    #' @examples
    #' # convert array of MobileAppRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MobileAppRequest to a base R type
    #'
