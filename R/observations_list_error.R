...
ObservationsListError <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
      ...
      } else if (get(class(instance)[[1]], pos = -1)$classname ==  "ObservationsListLocationNuts2ErrorComponent") {
        self$actual_instance <- instance
        self$actual_type <- "ObservationsListLocationNuts2ErrorComponent"
      } else if (get(class(instance)[[1]], pos = -1)$classname ==  "ObservationsListLocationNuts3ErrorComponent") {
        self$actual_instance <- instance
        self$actual_type <- "ObservationsListLocationNuts3ErrorComponent"
        ...
        stop(paste("Failed to initialize ObservationsListError with oneOf schemas ObservationsListCreatedAtErrorComponent, ObservationsListLocationCountryIdErrorComponent, ObservationsListLocationNuts2ErrorComponent, ObservationsListLocationNuts3ErrorComponent, ObservationsListOrderByErrorComponent, ObservationsListReceivedAtErrorComponent, ObservationsListShortIdErrorComponent, ObservationsListUpdatedAtErrorComponent, ObservationsListUserUuidErrorComponent. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      `ObservationsListLocationNuts3ErrorComponent_result` <- tryCatch({
          `ObservationsListLocationNuts3ErrorComponent`$public_methods$validateJSON(input)
          `ObservationsListLocationNuts3ErrorComponent_instance` <- `ObservationsListLocationNuts3ErrorComponent`$new()
          instance <- `ObservationsListLocationNuts3ErrorComponent_instance`$fromJSON(input)
          instance_type <- "ObservationsListLocationNuts3ErrorComponent"
          matched_schemas <- append(matched_schemas, "ObservationsListLocationNuts3ErrorComponent")
          matched <- matched + 1
        },
        error = function(err) err
      )

      if (!is.null(`ObservationsListLocationNuts3ErrorComponent_result`["error"])) {
        error_messages <- append(error_messages, `ObservationsListLocationNuts3ErrorComponent_result`["message"])
      }

      `ObservationsListLocationNuts2ErrorComponent_result` <- tryCatch({
          `ObservationsListLocationNuts2ErrorComponent`$public_methods$validateJSON(input)
          `ObservationsListLocationNuts2ErrorComponent_instance` <- `ObservationsListLocationNuts2ErrorComponent`$new()
          instance <- `ObservationsListLocationNuts2ErrorComponent_instance`$fromJSON(input)
          instance_type <- "ObservationsListLocationNuts2ErrorComponent"
          matched_schemas <- append(matched_schemas, "ObservationsListLocationNuts2ErrorComponent")
          matched <- matched + 1
        },
        error = function(err) err
      )

      if (!is.null(`ObservationsListLocationNuts2ErrorComponent_result`["error"])) {
        error_messages <- append(error_messages, `ObservationsListLocationNuts2ErrorComponent_result`["message"])
      }
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into ObservationsListError with oneOf schemas ObservationsListCreatedAtErrorComponent, ObservationsListLocationCountryIdErrorComponent, ObservationsListLocationNuts2ErrorComponent, ObservationsListLocationNuts3ErrorComponent, ObservationsListOrderByErrorComponent, ObservationsListReceivedAtErrorComponent, ObservationsListShortIdErrorComponent, ObservationsListUpdatedAtErrorComponent, ObservationsListUserUuidErrorComponent. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into ObservationsListError with oneOf schemas ObservationsListCreatedAtErrorComponent, ObservationsListLocationCountryIdErrorComponent, ObservationsListLocationNuts2ErrorComponent, ObservationsListLocationNuts3ErrorComponent, ObservationsListOrderByErrorComponent, ObservationsListReceivedAtErrorComponent, ObservationsListShortIdErrorComponent, ObservationsListUpdatedAtErrorComponent, ObservationsListUserUuidErrorComponent. Details: >>",
    ...
    #' @description
    #' Serialize ObservationsListError to JSON.
    #'
    #' @return JSON representation of the ObservationsListError.
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
