#' Create a new BreedingsitesListMineLocationNuts2ErrorComponent
#'
#' @description
#' BreedingsitesListMineLocationNuts2ErrorComponent Class
#'
#' @docType class
#' @title BreedingsitesListMineLocationNuts2ErrorComponent
#' @description BreedingsitesListMineLocationNuts2ErrorComponent Class
...
#' @export
BreedingsitesListMineLocationNuts2ErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BreedingsitesListMineLocationNuts2ErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BreedingsitesListMineLocationNuts2ErrorComponent as a base R list.
    #' @examples
    #' # convert array of BreedingsitesListMineLocationNuts2ErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BreedingsitesListMineLocationNuts2ErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BreedingsitesListMineLocationNuts2ErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BreedingsitesListMineLocationNuts2ErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BreedingsitesListMineLocationNuts2ErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BreedingsitesListMineLocationNuts2ErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BreedingsitesListMineLocationNuts2ErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BreedingsitesListMineLocationNuts2ErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BreedingsitesListMineLocationNuts2ErrorComponent
    ...
    #' @return BreedingsitesListMineLocationNuts2ErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BreedingsitesListMineLocationNuts2ErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesListMineLocationNuts2ErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesListMineLocationNuts2ErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesListMineLocationNuts2ErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BreedingsitesListMineLocationNuts2ErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BreedingsitesListMineLocationNuts2ErrorComponent$unlock()
#
## Below is an example to define the print function
# BreedingsitesListMineLocationNuts2ErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BreedingsitesListMineLocationNuts2ErrorComponent$lock()
