...
#' @docType class
#' @title MessageList
#' @description MessageList Class
#' @format An \code{R6Class} generator object
#' @field id  integer
#' @field sender_user  \link{SimpleUser}
#' @field content  \link{MessageListContent}
#' @field target  character
#' @field created_at  character
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
MessageList <- R6::R6Class(
  "MessageList",
  public = list(
    `id` = NULL,
    `sender_user` = NULL,
    ...
    #' @description
    #' Initialize a new MessageList class.
    #'
    #' @param id id
    ...
    #'
    #' @return MessageList as a base R list.
    #' @examples
    #' # convert array of MessageList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MessageListObject <- list()
      if (!is.null(self$`id`)) {
        MessageListObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`sender_user`)) {
        MessageListObject[["sender_user"]] <-
          self$extractSimpleType(self$`sender_user`)
      }
      if (!is.null(self$`content`)) {
        MessageListObject[["content"]] <-
          self$extractSimpleType(self$`content`)
      }
      if (!is.null(self$`target`)) {
        MessageListObject[["target"]] <-
          self$`target`
      }
      if (!is.null(self$`created_at`)) {
        MessageListObject[["created_at"]] <-
          self$`created_at`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of MessageList
    #'
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`content`)) {
        `content_object` <- MessageListContent$new()
    ...
    #' @return MessageList in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`content` <- MessageListContent$new()$fromJSON(jsonlite::toJSON(this_object$`content`, auto_unbox = TRUE, digits = NA))
      if (!is.null(this_object$`target`) && !(this_object$`target` %in% c("users", "audience"))) {
        stop(paste("Error! \"", this_object$`target`, "\" cannot be assigned to `target`. Must be \"users\", \"audience\".", sep = ""))
      }
      self$`target` <- this_object$`target`
    ...
    #' @description
    #' Validate JSON input with respect to MessageList and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MessageList: the required field `id` is missing."))
      }
      # check the required field `sender_user`
      if (!is.null(input_json$`sender_user`)) {
        stopifnot(R6::is.R6(input_json$`sender_user`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for MessageList: the required field `sender_user` is missing."))
      }
      # check the required field `content`
      if (!is.null(input_json$`content`)) {
        stopifnot(R6::is.R6(input_json$`content`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for MessageList: the required field `content` is missing."))
      }
      ...
      if (!is.null(input_json$`target`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MessageList: the required field `target` is missing."))
      }
      ...
      if (!is.null(input_json$`created_at`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MessageList: the required field `created_at` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of MessageList
    toString = function() {
      self$toJSONString()
    },
...
# MessageList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
