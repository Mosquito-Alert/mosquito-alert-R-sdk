#' Create a new BreedingsitesListBoundaryUuidErrorComponent
#'
#' @description
#' BreedingsitesListBoundaryUuidErrorComponent Class
#'
#' @docType class
#' @title BreedingsitesListBoundaryUuidErrorComponent
#' @description BreedingsitesListBoundaryUuidErrorComponent Class
...
#' @export
BreedingsitesListBoundaryUuidErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BreedingsitesListBoundaryUuidErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BreedingsitesListBoundaryUuidErrorComponent as a base R list.
    #' @examples
    #' # convert array of BreedingsitesListBoundaryUuidErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BreedingsitesListBoundaryUuidErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BreedingsitesListBoundaryUuidErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BreedingsitesListBoundaryUuidErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BreedingsitesListBoundaryUuidErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BreedingsitesListBoundaryUuidErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BreedingsitesListBoundaryUuidErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BreedingsitesListBoundaryUuidErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BreedingsitesListBoundaryUuidErrorComponent
    ...
    #' @return BreedingsitesListBoundaryUuidErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BreedingsitesListBoundaryUuidErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesListBoundaryUuidErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesListBoundaryUuidErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesListBoundaryUuidErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BreedingsitesListBoundaryUuidErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BreedingsitesListBoundaryUuidErrorComponent$unlock()
#
## Below is an example to define the print function
# BreedingsitesListBoundaryUuidErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BreedingsitesListBoundaryUuidErrorComponent$lock()
