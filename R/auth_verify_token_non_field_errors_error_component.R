#' Create a new AuthVerifyTokenNonFieldErrorsErrorComponent
#'
#' @description
#' AuthVerifyTokenNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title AuthVerifyTokenNonFieldErrorsErrorComponent
#' @description AuthVerifyTokenNonFieldErrorsErrorComponent Class
...
#' @export
AuthVerifyTokenNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AuthVerifyTokenNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return AuthVerifyTokenNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of AuthVerifyTokenNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AuthVerifyTokenNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AuthVerifyTokenNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        AuthVerifyTokenNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        AuthVerifyTokenNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        AuthVerifyTokenNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(AuthVerifyTokenNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of AuthVerifyTokenNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of AuthVerifyTokenNonFieldErrorsErrorComponent
    ...
    #' @return AuthVerifyTokenNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AuthVerifyTokenNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthVerifyTokenNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthVerifyTokenNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AuthVerifyTokenNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AuthVerifyTokenNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# AuthVerifyTokenNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# AuthVerifyTokenNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AuthVerifyTokenNonFieldErrorsErrorComponent$lock()
