#' Create a new BitesGeoListTagsErrorComponent
#'
#' @description
#' BitesGeoListTagsErrorComponent Class
#'
#' @docType class
#' @title BitesGeoListTagsErrorComponent
#' @description BitesGeoListTagsErrorComponent Class
...
#' @export
BitesGeoListTagsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BitesGeoListTagsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BitesGeoListTagsErrorComponent as a base R list.
    #' @examples
    #' # convert array of BitesGeoListTagsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BitesGeoListTagsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BitesGeoListTagsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BitesGeoListTagsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BitesGeoListTagsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BitesGeoListTagsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BitesGeoListTagsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BitesGeoListTagsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BitesGeoListTagsErrorComponent
    ...
    #' @return BitesGeoListTagsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BitesGeoListTagsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesGeoListTagsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesGeoListTagsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BitesGeoListTagsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BitesGeoListTagsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BitesGeoListTagsErrorComponent$unlock()
#
## Below is an example to define the print function
# BitesGeoListTagsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BitesGeoListTagsErrorComponent$lock()
