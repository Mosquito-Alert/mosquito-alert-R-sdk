#' Create a new ObservationsListMineBoundaryUuidErrorComponent
#'
#' @description
#' ObservationsListMineBoundaryUuidErrorComponent Class
#'
#' @docType class
#' @title ObservationsListMineBoundaryUuidErrorComponent
#' @description ObservationsListMineBoundaryUuidErrorComponent Class
...
#' @export
ObservationsListMineBoundaryUuidErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ObservationsListMineBoundaryUuidErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return ObservationsListMineBoundaryUuidErrorComponent as a base R list.
    #' @examples
    #' # convert array of ObservationsListMineBoundaryUuidErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ObservationsListMineBoundaryUuidErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ObservationsListMineBoundaryUuidErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        ObservationsListMineBoundaryUuidErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        ObservationsListMineBoundaryUuidErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        ObservationsListMineBoundaryUuidErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(ObservationsListMineBoundaryUuidErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ObservationsListMineBoundaryUuidErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of ObservationsListMineBoundaryUuidErrorComponent
    ...
    #' @return ObservationsListMineBoundaryUuidErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ObservationsListMineBoundaryUuidErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineBoundaryUuidErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineBoundaryUuidErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ObservationsListMineBoundaryUuidErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ObservationsListMineBoundaryUuidErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# ObservationsListMineBoundaryUuidErrorComponent$unlock()
#
## Below is an example to define the print function
# ObservationsListMineBoundaryUuidErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ObservationsListMineBoundaryUuidErrorComponent$lock()
