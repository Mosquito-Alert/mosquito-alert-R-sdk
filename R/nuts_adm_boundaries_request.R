#' Create a new NutsAdmBoundariesRequest
#'
#' @description
#' NutsAdmBoundariesRequest Class
#'
#' @docType class
#' @title NutsAdmBoundariesRequest
#' @description NutsAdmBoundariesRequest Class
...
#' @export
NutsAdmBoundariesRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new NutsAdmBoundariesRequest class.
    #'
    ...
    #'
    #' @return NutsAdmBoundariesRequest as a base R list.
    #' @examples
    #' # convert array of NutsAdmBoundariesRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert NutsAdmBoundariesRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      NutsAdmBoundariesRequestObject <- list()
      if (!is.null(self$`nuts2`)) {
        NutsAdmBoundariesRequestObject[["nuts2"]] <-
          self$`nuts2`
      }
      if (!is.null(self$`nuts3`)) {
        NutsAdmBoundariesRequestObject[["nuts3"]] <-
          self$`nuts3`
      }
      return(NutsAdmBoundariesRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of NutsAdmBoundariesRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of NutsAdmBoundariesRequest
    ...
    #' @return NutsAdmBoundariesRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to NutsAdmBoundariesRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`nuts2`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for NutsAdmBoundariesRequest: the required field `nuts2` is missing."))
      }
      ...
      if (!is.null(input_json$`nuts3`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for NutsAdmBoundariesRequest: the required field `nuts3` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of NutsAdmBoundariesRequest
    toString = function() {
      self$toJSONString()
    },
...
# NutsAdmBoundariesRequest$unlock()
#
## Below is an example to define the print function
# NutsAdmBoundariesRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# NutsAdmBoundariesRequest$lock()
