...
CampaignsListValidationError <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CampaignsListValidationError as a base R list.
    #' @examples
    #' # convert array of CampaignsListValidationError (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CampaignsListValidationError to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CampaignsListValidationErrorObject)
    },
