#' Create a new DeviceOsRequest
#'
#' @description
#' DeviceOsRequest Class
#'
#' @docType class
#' @title DeviceOsRequest
#' @description DeviceOsRequest Class
...
DeviceOsRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new DeviceOsRequest class.
    #'
    ...
    #'
    #' @return DeviceOsRequest as a base R list.
    #' @examples
    #' # convert array of DeviceOsRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeviceOsRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DeviceOsRequestObject <- list()
      if (!is.null(self$`name`)) {
        DeviceOsRequestObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`version`)) {
        DeviceOsRequestObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`locale`)) {
        DeviceOsRequestObject[["locale"]] <-
          self$`locale`
      }
      return(DeviceOsRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of DeviceOsRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of DeviceOsRequest
    ...
    #' @return DeviceOsRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to DeviceOsRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeviceOsRequest: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`version`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DeviceOsRequest: the required field `version` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of DeviceOsRequest
    toString = function() {
      self$toJSONString()
    },
...
# DeviceOsRequest$unlock()
#
## Below is an example to define the print function
# DeviceOsRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DeviceOsRequest$lock()
