#' Create a new PaginatedPartnerList
#'
#' @description
#' PaginatedPartnerList Class
#'
#' @docType class
#' @title PaginatedPartnerList
#' @description PaginatedPartnerList Class
#' @format An \code{R6Class} generator object
#' @field count  integer
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{Partner})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedPartnerList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedPartnerList class.
    #'
    #' @param count count
    ...
    #'
    #' @return PaginatedPartnerList as a base R list.
    #' @examples
    #' # convert array of PaginatedPartnerList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedPartnerList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedPartnerListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedPartnerListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedPartnerListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedPartnerListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedPartnerListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedPartnerListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedPartnerList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedPartnerList
    ...
    #' @return PaginatedPartnerList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedPartnerList and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PaginatedPartnerList: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`results`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PaginatedPartnerList: the required field `results` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PaginatedPartnerList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedPartnerList$unlock()
#
## Below is an example to define the print function
# PaginatedPartnerList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedPartnerList$lock()
