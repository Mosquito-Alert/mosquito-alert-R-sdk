  ...
  public = list(
    ...
    fromJSON = function(input) {
      ...
      `ObservationsListMineIdentificationTaxonIdsErrorComponent_result` <- tryCatch({
          ...
          instance <- `ObservationsListMineIdentificationTaxonIdsErrorComponent_instance`$fromJSON(input)
          instance_type <- "ObservationsListMineIdentificationTaxonIdsErrorComponent"
          matched_schemas <- append(matched_schemas, "ObservationsListMineIdentificationTaxonIdsErrorComponent")
          matched <- matched + 1
        },
        error = function(err) err
      )

      if (!is.null(`ObservationsListMineIdentificationTaxonIdsErrorComponent_result`["error"])) {
