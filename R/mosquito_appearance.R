#' Create a new MosquitoAppearance
#'
#' @description
#' MosquitoAppearance Class
#'
#' @docType class
#' @title MosquitoAppearance
#' @description MosquitoAppearance Class
...
MosquitoAppearance <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MosquitoAppearance class.
    #'
    ...
    #'
    #' @return MosquitoAppearance as a base R list.
    #' @examples
    #' # convert array of MosquitoAppearance (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MosquitoAppearance to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MosquitoAppearanceObject <- list()
      if (!is.null(self$`specie`)) {
        MosquitoAppearanceObject[["specie"]] <-
          self$`specie`
      }
      if (!is.null(self$`thorax`)) {
        MosquitoAppearanceObject[["thorax"]] <-
          self$`thorax`
      }
      if (!is.null(self$`abdomen`)) {
        MosquitoAppearanceObject[["abdomen"]] <-
          self$`abdomen`
      }
      if (!is.null(self$`legs`)) {
        MosquitoAppearanceObject[["legs"]] <-
          self$`legs`
      }
      return(MosquitoAppearanceObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of MosquitoAppearance
    #'
    #' @param input_json the JSON input
    #' @return the instance of MosquitoAppearance
    ...
    #' @return MosquitoAppearance in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MosquitoAppearance and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of MosquitoAppearance
    toString = function() {
      self$toJSONString()
    },
...
# MosquitoAppearance$unlock()
#
## Below is an example to define the print function
# MosquitoAppearance$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MosquitoAppearance$lock()
