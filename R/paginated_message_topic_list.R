#' Create a new PaginatedMessageTopicList
#'
#' @description
#' PaginatedMessageTopicList Class
#'
#' @docType class
#' @title PaginatedMessageTopicList
#' @description PaginatedMessageTopicList Class
#' @format An \code{R6Class} generator object
#' @field count  integer
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{MessageTopic})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedMessageTopicList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedMessageTopicList class.
    #'
    #' @param count count
    ...
    #'
    #' @return PaginatedMessageTopicList as a base R list.
    #' @examples
    #' # convert array of PaginatedMessageTopicList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedMessageTopicList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedMessageTopicListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedMessageTopicListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedMessageTopicListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedMessageTopicListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedMessageTopicListObject[["results"]] <-
          self$extractSimpleType(self$`results`)
      }
      return(PaginatedMessageTopicListObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of PaginatedMessageTopicList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedMessageTopicList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[MessageTopic]", loadNamespace("MosquitoAlert"))
      }
      self
    },
    ...
    #' @return PaginatedMessageTopicList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedMessageTopicList and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PaginatedMessageTopicList: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`results`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PaginatedMessageTopicList: the required field `results` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PaginatedMessageTopicList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedMessageTopicList$unlock()
#
## Below is an example to define the print function
# PaginatedMessageTopicList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedMessageTopicList$lock()
