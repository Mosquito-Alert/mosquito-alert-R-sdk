  ...
  public = list(
    ...
    create_with_http_info = function(device_request, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "Device", loadNamespace("MosquitoAlert")),
          error = function(e) {
    ...
    partial_update_with_http_info = function(device_id, patched_device_update_request = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "DeviceUpdate", loadNamespace("MosquitoAlert")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
