#' Create a new AdmBoundaryRequest
#'
#' @description
#' AdmBoundaryRequest Class
#'
#' @docType class
#' @title AdmBoundaryRequest
#' @description AdmBoundaryRequest Class
...
AdmBoundaryRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AdmBoundaryRequest class.
    #'
    #' @param name name
    #' @param code code
    #' @param source source
    ...
    #'
    #' @return AdmBoundaryRequest as a base R list.
    #' @examples
    #' # convert array of AdmBoundaryRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AdmBoundaryRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AdmBoundaryRequestObject <- list()
      if (!is.null(self$`name`)) {
        AdmBoundaryRequestObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`code`)) {
        AdmBoundaryRequestObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`source`)) {
        AdmBoundaryRequestObject[["source"]] <-
          self$`source`
      }
      if (!is.null(self$`level`)) {
        AdmBoundaryRequestObject[["level"]] <-
          self$`level`
      }
      return(AdmBoundaryRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of AdmBoundaryRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of AdmBoundaryRequest
    ...
    #' @return AdmBoundaryRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AdmBoundaryRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdmBoundaryRequest: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdmBoundaryRequest: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`source`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdmBoundaryRequest: the required field `source` is missing."))
      }
      ...
      if (!is.null(input_json$`level`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for AdmBoundaryRequest: the required field `level` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of AdmBoundaryRequest
    toString = function() {
      self$toJSONString()
    },
    ...
    getInvalidFields = function() {
      ...
      if (nchar(self$`source`) < 1) {
        invalid_fields["source"] <- "Invalid length for `source`, must be bigger than or equal to 1."
      }
...
# AdmBoundaryRequest$unlock()
#
## Below is an example to define the print function
# AdmBoundaryRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AdmBoundaryRequest$lock()
