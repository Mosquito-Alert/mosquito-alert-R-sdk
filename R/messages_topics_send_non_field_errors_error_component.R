#' Create a new MessagesTopicsSendNonFieldErrorsErrorComponent
#'
#' @description
#' MessagesTopicsSendNonFieldErrorsErrorComponent Class
#'
#' @docType class
#' @title MessagesTopicsSendNonFieldErrorsErrorComponent
#' @description MessagesTopicsSendNonFieldErrorsErrorComponent Class
...
#' @export
MessagesTopicsSendNonFieldErrorsErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MessagesTopicsSendNonFieldErrorsErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return MessagesTopicsSendNonFieldErrorsErrorComponent as a base R list.
    #' @examples
    #' # convert array of MessagesTopicsSendNonFieldErrorsErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessagesTopicsSendNonFieldErrorsErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MessagesTopicsSendNonFieldErrorsErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        MessagesTopicsSendNonFieldErrorsErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        MessagesTopicsSendNonFieldErrorsErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        MessagesTopicsSendNonFieldErrorsErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(MessagesTopicsSendNonFieldErrorsErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of MessagesTopicsSendNonFieldErrorsErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of MessagesTopicsSendNonFieldErrorsErrorComponent
    ...
    #' @return MessagesTopicsSendNonFieldErrorsErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MessagesTopicsSendNonFieldErrorsErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MessagesTopicsSendNonFieldErrorsErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MessagesTopicsSendNonFieldErrorsErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MessagesTopicsSendNonFieldErrorsErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of MessagesTopicsSendNonFieldErrorsErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# MessagesTopicsSendNonFieldErrorsErrorComponent$unlock()
#
## Below is an example to define the print function
# MessagesTopicsSendNonFieldErrorsErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MessagesTopicsSendNonFieldErrorsErrorComponent$lock()
