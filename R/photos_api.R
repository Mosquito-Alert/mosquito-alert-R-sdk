...
PhotosApi <- R6::R6Class(
  ...
  public = list(
    ...
    prediction_partial_update = function(uuid, patched_photo_prediction_request = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$prediction_partial_update_with_http_info(uuid, patched_photo_prediction_request, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    prediction_partial_update_with_http_info = function(uuid, patched_photo_prediction_request = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return PhotoPrediction
    prediction_retrieve = function(uuid, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$prediction_retrieve_with_http_info(uuid, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (PhotoPrediction) with additional information such as HTTP status code, headers
    prediction_retrieve_with_http_info = function(uuid, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    #'
    #' @return PhotoPrediction
    prediction_update = function(uuid, photo_prediction_request, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$prediction_update_with_http_info(uuid, photo_prediction_request, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (PhotoPrediction) with additional information such as HTTP status code, headers
    prediction_update_with_http_info = function(uuid, photo_prediction_request, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
