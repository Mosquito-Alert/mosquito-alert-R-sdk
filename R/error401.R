...
Error401 <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new Error401 class.
    #'
    #' @param code code
    #' @param detail detail
    #' @param attr attr
    ...
    #'
    #' @return Error401 as a base R list.
    #' @examples
    #' # convert array of Error401 (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert Error401 to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(Error401Object)
    },

    #' @description
    #' Deserialize JSON string into an instance of Error401
    #'
    ...
    #' @return Error401 in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to Error401 and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Error401: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Error401: the required field `detail` is missing."))
      }
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for Error401: the required field `attr` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of Error401
    toString = function() {
      self$toJSONString()
    },
...
# Error401$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
