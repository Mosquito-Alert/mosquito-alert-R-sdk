#' Create a new LocalizedTopicMessageTitleRequest
#'
#' @description
...
#'
#' @docType class
#' @title LocalizedTopicMessageTitleRequest
#' @description LocalizedTopicMessageTitleRequest Class
...
#' @export
LocalizedTopicMessageTitleRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return LocalizedTopicMessageTitleRequest as a base R list.
    #' @examples
    #' # convert array of LocalizedTopicMessageTitleRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LocalizedTopicMessageTitleRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LocalizedTopicMessageTitleRequestObject <- list()
      if (!is.null(self$`bg`)) {
        LocalizedTopicMessageTitleRequestObject[["bg"]] <-
          self$`bg`
      }
      if (!is.null(self$`bn`)) {
        LocalizedTopicMessageTitleRequestObject[["bn"]] <-
          self$`bn`
      }
      if (!is.null(self$`ca`)) {
        LocalizedTopicMessageTitleRequestObject[["ca"]] <-
          self$`ca`
      }
      if (!is.null(self$`de`)) {
        LocalizedTopicMessageTitleRequestObject[["de"]] <-
          self$`de`
      }
      if (!is.null(self$`el`)) {
        LocalizedTopicMessageTitleRequestObject[["el"]] <-
          self$`el`
      }
      if (!is.null(self$`en`)) {
        LocalizedTopicMessageTitleRequestObject[["en"]] <-
          self$`en`
      }
      if (!is.null(self$`es`)) {
        LocalizedTopicMessageTitleRequestObject[["es"]] <-
          self$`es`
      }
      if (!is.null(self$`eu`)) {
        LocalizedTopicMessageTitleRequestObject[["eu"]] <-
          self$`eu`
      }
      if (!is.null(self$`fr`)) {
        LocalizedTopicMessageTitleRequestObject[["fr"]] <-
          self$`fr`
      }
      if (!is.null(self$`gl`)) {
        LocalizedTopicMessageTitleRequestObject[["gl"]] <-
          self$`gl`
      }
      if (!is.null(self$`hr`)) {
        LocalizedTopicMessageTitleRequestObject[["hr"]] <-
          self$`hr`
      }
      if (!is.null(self$`hu`)) {
        LocalizedTopicMessageTitleRequestObject[["hu"]] <-
          self$`hu`
      }
      if (!is.null(self$`it`)) {
        LocalizedTopicMessageTitleRequestObject[["it"]] <-
          self$`it`
      }
      if (!is.null(self$`lb`)) {
        LocalizedTopicMessageTitleRequestObject[["lb"]] <-
          self$`lb`
      }
      if (!is.null(self$`mk`)) {
        LocalizedTopicMessageTitleRequestObject[["mk"]] <-
          self$`mk`
      }
      if (!is.null(self$`nl`)) {
        LocalizedTopicMessageTitleRequestObject[["nl"]] <-
          self$`nl`
      }
      if (!is.null(self$`pt`)) {
        LocalizedTopicMessageTitleRequestObject[["pt"]] <-
          self$`pt`
      }
      if (!is.null(self$`ro`)) {
        LocalizedTopicMessageTitleRequestObject[["ro"]] <-
          self$`ro`
      }
      if (!is.null(self$`sl`)) {
        LocalizedTopicMessageTitleRequestObject[["sl"]] <-
          self$`sl`
      }
      if (!is.null(self$`sq`)) {
        LocalizedTopicMessageTitleRequestObject[["sq"]] <-
          self$`sq`
      }
      if (!is.null(self$`sr`)) {
        LocalizedTopicMessageTitleRequestObject[["sr"]] <-
          self$`sr`
      }
      if (!is.null(self$`sv`)) {
        LocalizedTopicMessageTitleRequestObject[["sv"]] <-
          self$`sv`
      }
      if (!is.null(self$`tr`)) {
    ...
    #' @description
    #' Deserialize JSON string into an instance of LocalizedTopicMessageTitleRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of LocalizedTopicMessageTitleRequest
    ...
    #' @return LocalizedTopicMessageTitleRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LocalizedTopicMessageTitleRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`en`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LocalizedTopicMessageTitleRequest: the required field `en` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LocalizedTopicMessageTitleRequest
    toString = function() {
      self$toJSONString()
    },
...
# LocalizedTopicMessageTitleRequest$unlock()
#
## Below is an example to define the print function
# LocalizedTopicMessageTitleRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LocalizedTopicMessageTitleRequest$lock()
