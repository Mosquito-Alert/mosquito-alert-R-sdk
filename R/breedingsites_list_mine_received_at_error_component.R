#' Create a new BreedingsitesListMineReceivedAtErrorComponent
#'
#' @description
#' BreedingsitesListMineReceivedAtErrorComponent Class
#'
#' @docType class
#' @title BreedingsitesListMineReceivedAtErrorComponent
#' @description BreedingsitesListMineReceivedAtErrorComponent Class
...
#' @export
BreedingsitesListMineReceivedAtErrorComponent <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BreedingsitesListMineReceivedAtErrorComponent class.
    #'
    #' @param attr attr
    #' @param code code
    #' @param detail detail
    ...
    #'
    #' @return BreedingsitesListMineReceivedAtErrorComponent as a base R list.
    #' @examples
    #' # convert array of BreedingsitesListMineReceivedAtErrorComponent (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BreedingsitesListMineReceivedAtErrorComponent to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BreedingsitesListMineReceivedAtErrorComponentObject <- list()
      if (!is.null(self$`attr`)) {
        BreedingsitesListMineReceivedAtErrorComponentObject[["attr"]] <-
          self$`attr`
      }
      if (!is.null(self$`code`)) {
        BreedingsitesListMineReceivedAtErrorComponentObject[["code"]] <-
          self$`code`
      }
      if (!is.null(self$`detail`)) {
        BreedingsitesListMineReceivedAtErrorComponentObject[["detail"]] <-
          self$`detail`
      }
      return(BreedingsitesListMineReceivedAtErrorComponentObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BreedingsitesListMineReceivedAtErrorComponent
    #'
    #' @param input_json the JSON input
    #' @return the instance of BreedingsitesListMineReceivedAtErrorComponent
    ...
    #' @return BreedingsitesListMineReceivedAtErrorComponent in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BreedingsitesListMineReceivedAtErrorComponent and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`attr`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesListMineReceivedAtErrorComponent: the required field `attr` is missing."))
      }
      ...
      if (!is.null(input_json$`code`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesListMineReceivedAtErrorComponent: the required field `code` is missing."))
      }
      ...
      if (!is.null(input_json$`detail`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for BreedingsitesListMineReceivedAtErrorComponent: the required field `detail` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of BreedingsitesListMineReceivedAtErrorComponent
    toString = function() {
      self$toJSONString()
    },
...
# BreedingsitesListMineReceivedAtErrorComponent$unlock()
#
## Below is an example to define the print function
# BreedingsitesListMineReceivedAtErrorComponent$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BreedingsitesListMineReceivedAtErrorComponent$lock()
