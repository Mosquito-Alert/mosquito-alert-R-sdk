...
MessagesCreateError <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(instance = NULL) {
      ...
      } else if (get(class(instance)[[1]], pos = -1)$classname ==  "MessagesCreateAudienceNotificationTopicsErrorComponent") {
        self$actual_instance <- instance
        self$actual_type <- "MessagesCreateAudienceNotificationTopicsErrorComponent"
      } else if (get(class(instance)[[1]], pos = -1)$classname ==  "MessagesCreateAudienceNotificationTopicsINDEXErrorComponent") {
        self$actual_instance <- instance
        self$actual_type <- "MessagesCreateAudienceNotificationTopicsINDEXErrorComponent"
    ...
    fromJSON = function(input) {
      ...
      `MessagesCreateAudienceNotificationTopicsErrorComponent_result` <- tryCatch({
          `MessagesCreateAudienceNotificationTopicsErrorComponent`$public_methods$validateJSON(input)
          `MessagesCreateAudienceNotificationTopicsErrorComponent_instance` <- `MessagesCreateAudienceNotificationTopicsErrorComponent`$new()
          instance <- `MessagesCreateAudienceNotificationTopicsErrorComponent_instance`$fromJSON(input)
          instance_type <- "MessagesCreateAudienceNotificationTopicsErrorComponent"
          matched_schemas <- append(matched_schemas, "MessagesCreateAudienceNotificationTopicsErrorComponent")
          matched <- matched + 1
        },
        error = function(err) err
      )

      if (!is.null(`MessagesCreateAudienceNotificationTopicsErrorComponent_result`["error"])) {
        error_messages <- append(error_messages, `MessagesCreateAudienceNotificationTopicsErrorComponent_result`["message"])
      }

      `MessagesCreateAudienceNotificationTopicsINDEXErrorComponent_result` <- tryCatch({
          `MessagesCreateAudienceNotificationTopicsINDEXErrorComponent`$public_methods$validateJSON(input)
          `MessagesCreateAudienceNotificationTopicsINDEXErrorComponent_instance` <- `MessagesCreateAudienceNotificationTopicsINDEXErrorComponent`$new()
          instance <- `MessagesCreateAudienceNotificationTopicsINDEXErrorComponent_instance`$fromJSON(input)
          instance_type <- "MessagesCreateAudienceNotificationTopicsINDEXErrorComponent"
          matched_schemas <- append(matched_schemas, "MessagesCreateAudienceNotificationTopicsINDEXErrorComponent")
          matched <- matched + 1
        },
        error = function(err) err
      )

      if (!is.null(`MessagesCreateAudienceNotificationTopicsINDEXErrorComponent_result`["error"])) {
        error_messages <- append(error_messages, `MessagesCreateAudienceNotificationTopicsINDEXErrorComponent_result`["message"])
      }
