#' Create a new CreatePhotoPredictionRequest
#'
#' @description
#' CreatePhotoPredictionRequest Class
#'
#' @docType class
#' @title CreatePhotoPredictionRequest
#' @description CreatePhotoPredictionRequest Class
#' @format An \code{R6Class} generator object
#' @field photo_uuid  character
...
#' @export
CreatePhotoPredictionRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CreatePhotoPredictionRequest class.
    #'
    #' @param photo_uuid photo_uuid
    #' @param bbox bbox
    ...
    initialize = function(`photo_uuid`, `bbox`, `insect_confidence`, `predicted_class`, `threshold_deviation`, `scores`, `classifier_version`, `is_decisive` = NULL, ...) {
      if (!missing(`photo_uuid`)) {
        if (!(is.character(`photo_uuid`) && length(`photo_uuid`) == 1)) {
          stop(paste("Error! Invalid data for `photo_uuid`. Must be a string:", `photo_uuid`))
        }
    ...
    #'
    #' @return CreatePhotoPredictionRequest as a base R list.
    #' @examples
    #' # convert array of CreatePhotoPredictionRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreatePhotoPredictionRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CreatePhotoPredictionRequestObject <- list()
      if (!is.null(self$`photo_uuid`)) {
        CreatePhotoPredictionRequestObject[["photo_uuid"]] <-
          self$`photo_uuid`
      }
      ...
      if (!is.null(self$`predicted_class`)) {
        CreatePhotoPredictionRequestObject[["predicted_class"]] <-
          self$`predicted_class`
      }
      if (!is.null(self$`threshold_deviation`)) {
        CreatePhotoPredictionRequestObject[["threshold_deviation"]] <-
          self$`threshold_deviation`
      }
      if (!is.null(self$`is_decisive`)) {
        CreatePhotoPredictionRequestObject[["is_decisive"]] <-
          self$`is_decisive`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of CreatePhotoPredictionRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of CreatePhotoPredictionRequest
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`photo_uuid`)) {
        self$`photo_uuid` <- this_object$`photo_uuid`
      }
    ...
    #' @return CreatePhotoPredictionRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CreatePhotoPredictionRequest and throw an exception if invalid
    #'
    #' @param input the JSON input
    validateJSON = function(input) {
      input_json <- jsonlite::fromJSON(input)
      # check the required field `photo_uuid`
      if (!is.null(input_json$`photo_uuid`)) {
        if (!(is.character(input_json$`photo_uuid`) && length(input_json$`photo_uuid`) == 1)) {
          stop(paste("Error! Invalid data for `photo_uuid`. Must be a string:", input_json$`photo_uuid`))
        }
      } else {
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPredictionRequest: the required field `photo_uuid` is missing."))
      }
      # check the required field `bbox`
      if (!is.null(input_json$`bbox`)) {
        stopifnot(R6::is.R6(input_json$`bbox`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPredictionRequest: the required field `bbox` is missing."))
      }
      ...
      if (!is.null(input_json$`insect_confidence`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPredictionRequest: the required field `insect_confidence` is missing."))
      }
      ...
      if (!is.null(input_json$`predicted_class`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPredictionRequest: the required field `predicted_class` is missing."))
      }
      ...
      if (!is.null(input_json$`threshold_deviation`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPredictionRequest: the required field `threshold_deviation` is missing."))
      }
      # check the required field `scores`
      if (!is.null(input_json$`scores`)) {
        stopifnot(R6::is.R6(input_json$`scores`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPredictionRequest: the required field `scores` is missing."))
      }
      ...
      if (!is.null(input_json$`classifier_version`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreatePhotoPredictionRequest: the required field `classifier_version` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CreatePhotoPredictionRequest
    toString = function() {
      self$toJSONString()
    },
    ...
    #' @return true if the values in all fields are valid.
    isValid = function() {
      # check if the required `photo_uuid` is null
      if (is.null(self$`photo_uuid`)) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      # check if the required `photo_uuid` is null
      if (is.null(self$`photo_uuid`)) {
        invalid_fields["photo_uuid"] <- "Non-nullable required field `photo_uuid` cannot be null."
      }
...
# CreatePhotoPredictionRequest$unlock()
#
## Below is an example to define the print function
# CreatePhotoPredictionRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CreatePhotoPredictionRequest$lock()
