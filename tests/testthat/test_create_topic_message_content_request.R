...
context("Test CreateTopicMessageContentRequest")

model_instance <- CreateTopicMessageContentRequest$new()

test_that("title", {
  # tests for the property `title` (LocalizedTopicMessageTitleRequest)
...
test_that("body", {
  # tests for the property `body` (LocalizedTopicMessageBodyRequest)
